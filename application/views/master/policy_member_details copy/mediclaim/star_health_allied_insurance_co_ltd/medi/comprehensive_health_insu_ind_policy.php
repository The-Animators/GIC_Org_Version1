    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="medi_star_health_comp_ind_policy_id" name="medi_star_health_comp_ind_policy_id" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    function Total_Medi_starHealth_comprehensive() {
    ...
    function get_basic_premium(add_medi_starHealth_counter) {
        ...
        if(years_of_premium == "1")
            var condition_value = getcolumnOnage_1year(name_insured_age);
        else if(years_of_premium == "2")
            var condition_value = getcolumnOnage_2year(name_insured_age);
        else if(years_of_premium == "3")
            var condition_value = getcolumnOnage_3year(name_insured_age);
        ...
        if (years_of_premium != "null" && years_of_premium != "" && name_insured_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && column_value != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_star_health_allied_comprehensive_ind_basic_prem";
