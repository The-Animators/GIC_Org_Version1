...
<script>
    ...
    function family_Size_Val(family_size_new) {
        ...
        if(family_size_new != "" && family_size_new !="null" && family_size_new !=undefined)
            ...
            var family_size = $("#hdfc_ergo_health_insu_supertopup_float_family_size").val();
    ...
    function family_Size_coulumn(hdfc_ergo_health_insu_supertopup_float_family_size) {
        var column_value = "";
        if (hdfc_ergo_health_insu_supertopup_float_family_size == "1A + 1C")
           column_value = "1a_1c";
        else if (hdfc_ergo_health_insu_supertopup_float_family_size == "1A + 2C")
           column_value = "1a_2c";
        else if (hdfc_ergo_health_insu_supertopup_float_family_size == "1A + 3C")
           column_value = "1a_3c";
        else if (hdfc_ergo_health_insu_supertopup_float_family_size == "2A + 0C")
           column_value = "2a";
        else if (hdfc_ergo_health_insu_supertopup_float_family_size == "2A + 1C")
           column_value = "2a_1c";
        else if (hdfc_ergo_health_insu_supertopup_float_family_size == "2A + 2C")
           column_value = "2a_2c";
    ...
    function get_basic_premium() {
        ...
        var column_value = family_Size_coulumn(hdfc_ergo_health_insu_supertopup_float_family_size);
