...
<div class="row">
    ...
    <div class="col-md-12" style="overflow-x:auto;">
        <table class="table mb-0 table-bordered" id="first_table">
            <thead>
                <tr>
                    <th><button class="btn btn-primary btn-sm Add_Mediclaim_maxBupa" id="Add_Mediclaim_maxBupa" onclick="AddMediclaimmaxBupa(0)">Add</button></th>
    ...
    <div class="col-md-12">
        ...
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr id="">
                ...
                <td colspn=""><strong><input type="text" id="family_disc_per" name="family_disc_per" class="form-control family_disc_per"  onkeyup="medi_family_disc_tot_Cal()" value="10"></strong></td>
            ...
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="medi_max_bupa_reassure_ind_policy_id" name="medi_max_bupa_reassure_ind_policy_id" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    function removeMediclaimmaxBupa(add_medi_maxBupa_counter) {
        ...
        // get_year_wise_term_discount(add_medi_maxBupa_counter);
    ...
    function AddMediclaimmaxBupa(add_medi_maxBupa_counter) {
        ...
        add_medi_maxBupa_counter = add_medi_maxBupa_counter + 1;
        $("#Add_Mediclaim_maxBupa").attr("onClick", "AddMediclaimmaxBupa(" + add_medi_maxBupa_counter + ")");
    }
    ...
    function check_suminsured(add_medi_maxBupa_counter) {

        var name_insured_sum_insured = $("#name_insured_sum_insured_" + add_medi_maxBupa_counter).val();
        ...
        if (name_insured_member_name == "null" || name_insured_member_name == "") {
            ...
            $('#name_insured_sum_insured_' + add_medi_maxBupa_counter).prop('selectedIndex', 0);
            $('#pab_type_' + add_medi_maxBupa_counter).prop('selectedIndex', 0);
            $('#hospital_cash_type_' + add_medi_maxBupa_counter).prop('selectedIndex', 0);
            $('#safeguard_benefi_type_' + add_medi_maxBupa_counter).prop('selectedIndex', 0);
            $('#pab_prem_' + add_medi_maxBupa_counter).val("");
            $('#hospital_cash_prem_' + add_medi_maxBupa_counter).val("");
            $('#safeguard_benefi_prem_' + add_medi_maxBupa_counter).val("");
            return false;
        }

        get_pab_type_premium(add_medi_maxBupa_counter);
        get_hospital_cash_type_prem(add_medi_maxBupa_counter);
        get_safeguard_benefi_type_prem(add_medi_maxBupa_counter);
        Tot_Benefit_Cal(add_medi_maxBupa_counter);
    }
    ...
    function Total_Medi_max_bupa_reassure() {
    ...
    function get_pab_type_premium(add_medi_maxBupa_counter) {
        $('#pab_prem_' + add_medi_maxBupa_counter).val("");
        var pab_type = $("#pab_type_" + add_medi_maxBupa_counter).val();
        var name_insured_age = $("#name_insured_age_" + add_medi_maxBupa_counter).val();
        var basic_premium = $("#basic_premium_" + add_medi_maxBupa_counter).val();
        ...
        if(pab_type == "Opted"){
            if(name_insured_age >= 18){
                ...
                $("#pab_prem_" + add_medi_maxBupa_counter).val(pab_prem);
            }
        }else{
            $("#pab_prem_" + add_medi_maxBupa_counter).val(pab_prem);
        }
    ...
    function get_hospital_cash_type_prem(add_medi_maxBupa_counter) {
        $('#hospital_cash_prem_' + add_medi_maxBupa_counter).val("");
        var hospital_cash_type = $("#hospital_cash_type_" + add_medi_maxBupa_counter).val();
        var name_insured_age = $("#name_insured_age_" + add_medi_maxBupa_counter).val();
        var basic_premium = $("#basic_premium_" + add_medi_maxBupa_counter).val();
        basic_premium = parseInt(basic_premium);
        if(isNaN(basic_premium))
        ...
        if(hospital_cash_type == "Opted"){
            ...
            $("#hospital_cash_prem_" + add_medi_maxBupa_counter).val(hospital_cash_prem);
        }else{
            $("#hospital_cash_prem_" + add_medi_maxBupa_counter).val(hospital_cash_prem);
        }
        Tot_Benefit_Cal(add_medi_maxBupa_counter);
    ...
    function get_safeguard_benefi_type_prem(add_medi_maxBupa_counter) {
        var name_insured_sum_insured = $("#name_insured_sum_insured_" + add_medi_maxBupa_counter).val();
        name_insured_sum_insured = sum_insured_int_Converter(name_insured_sum_insured);
        $('#safeguard_benefi_prem_' + add_medi_maxBupa_counter).val("");
        var safeguard_benefi_type = $("#safeguard_benefi_type_" + add_medi_maxBupa_counter).val();
        var name_insured_age = $("#name_insured_age_" + add_medi_maxBupa_counter).val();
        var basic_premium = $("#basic_premium_" + add_medi_maxBupa_counter).val();
        basic_premium = parseInt(basic_premium);
        if(isNaN(basic_premium))
        ...
        if(safeguard_benefi_type == "Opted"){
            ...
            $("#safeguard_benefi_prem_" + add_medi_maxBupa_counter).val(safeguard_benefi_prem);
    ...
    function get_basic_premium(add_medi_maxBupa_counter) {
        // alert("Hello")
        var functionIsRunning=get_basic_premium_basedon_region(flag=true,main_Mediclaim_maxBupa);
        if(functionIsRunning == true){
            // var second_year_tot = 0;
            // var third_year_tot = 0;
            return false;
        }
        // alert(functionIsRunning);

        $('#basic_premium_' + add_medi_maxBupa_counter).val("");
        $('#tot_prem_' + add_medi_maxBupa_counter).val("");
        check_suminsured(add_medi_maxBupa_counter);
        Tot_Benefit_Cal(add_medi_maxBupa_counter);
        // get_year_wise_term_discount(add_medi_maxBupa_counter);
        ...
        if (years_of_premium != "null" && years_of_premium != "" && region != "null" && region != "" && name_insured_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && column_value != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_max_bupa_reassure_ind_basic_prem";
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        if (data["status"] == true) {
                            ...
                            $('#basic_premium_' + add_medi_maxBupa_counter).val("");
                            $('#basic_premium_' + add_medi_maxBupa_counter).val(data["userdata"]);
                        ...
                        Tot_Benefit_Cal(add_medi_maxBupa_counter);
                        // get_year_wise_term_discount(add_medi_maxBupa_counter);
                        var term_disc = get_year_wise_term_discount(add_medi_maxBupa_counter);
                        // alert(term_disc);
    ...
    // var second_year_tot = 0;
    // var third_year_tot = 0;
    // var second_year_tot_new = 0;
    // var third_year_tot_new = 0;

    function get_basic_premium_basedon_region(flag,main_Mediclaim_maxBupa){
       
        if(flag==false){
            var functionIsRunning = true;
            $.each(main_Mediclaim_maxBupa, function(key, val) {
            ...
            $.each(main_Mediclaim_maxBupa, function(key, val) {
                ...
                Tot_Benefit_Cal(val);
                // alert(val);
                // var term_disc = get_year_wise_term_discount(val);
                // alert(term_disc);
                // if(term_disc != undefined || term_disc != "undefined" || term_disc !="" || term_disc !="null" || term_disc !=null){
                //     term_disc = term_disc.split("-");
                //     var sec_year_tot = term_disc[0];
                ...
                //     second_year_tot = second_year_tot + sec_year_tot;
                //     third_year_tot = third_year_tot + th_year_tot;
                ...
                // get_year_wise_term_discount(val);

                var name_insured_member_name = $("#name_insured_member_name_" + val).val();
                if (name_insured_member_name == "null" || name_insured_member_name == "") {
                    toaster(message_type = "Error", message_txt = "The Name Of Insured field is required.", message_icone = "error");
                    $('#name_insured_sum_insured_' + val).prop('selectedIndex', 0);
                    $('#pab_type_' + val).prop('selectedIndex', 0);
                    $('#hospital_cash_type_' + val).prop('selectedIndex', 0);
                    $('#safeguard_benefi_type_' + val).prop('selectedIndex', 0);
                    $('#pab_prem_' + val).val("");
                    $('#hospital_cash_prem_' + val).val("");
                    $('#safeguard_benefi_prem_' + val).val("");
                    return false;
                }
        ...
        return functionIsRunning;
    }

    function Tot_Benefit_Cal(add_medi_maxBupa_counter){
        var basic_premium = $("#basic_premium_" + add_medi_maxBupa_counter).val();
        var pab_prem = $("#pab_prem_" + add_medi_maxBupa_counter).val();
        var hospital_cash_prem = $("#hospital_cash_prem_" + add_medi_maxBupa_counter).val();
        var safeguard_benefi_prem = $("#safeguard_benefi_prem_" + add_medi_maxBupa_counter).val();
        ...
        if (isNaN(tot_prem))
            ...
            tot_prem = tot_prem;
        $("#tot_prem_" + add_medi_maxBupa_counter).val(tot_prem);
    ...
    function medi_doctor_disc_tot_Cal(total){
        ...
        // if(vals==0 && vals!="#"){
        //     $("#doctor_disc_per").val(5);
        // }else{
        //     $("#doctor_disc_per").val(0);
        // }
    ...
    function medi_family_disc_tot_Cal(){
        ...
        family_disc_tot = Math.round((family_disc_per * total) /100);
    ...
    function get_year_wise_term_discount(add_medi_maxBupa_counter) {
        $("#second_year_tot").val("");
        $("#third_year_tot").val("");
        ...
        if (years_of_premium != "null" && years_of_premium != "" && region != "null" && region != "" && name_insured_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && column_value != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_max_bupa_reassure_ind_year_wise_term_discount";
                        ...
                        if (data["status"] == true) {
                            ...
                            for (var i = 0; i < column.length; i++) {
                                ...
                                if(i == 1){
                                    ...
                                    // alert(premium_rate+"first");
                                    // alert(val.length+"first");
                                    ...
                                    // alert(premium_rate_1);
                                    // alert(premium_rate_2);
    ...
    function Tot_premium_after_discount() {
        ...
        var discount = 0;
        discount = tot_term_disc + stand_instu_tot + doctor_disc_tot + family_disc_tot;
        ...
        //     alert(gross_premium_tot_new);
        // alert(discount);
        // alert(last_gross_premium_tot);
