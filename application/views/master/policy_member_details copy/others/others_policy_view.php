        ...
        <table class="table mb-0 table-bordered">
            ...
            <tr>
                ...
                <td><strong>
                        ...
                        <input type="hidden" name="other_policy_id" id="other_policy_id" value="" class="form-control">
                    </strong></td>
            </tr>
        </table>
    </div>
...
<script>
    ...
    function gst_apply() {
        ...
        var cgst_fire_tot = Math.round((fire_rate_after_discount_tot * cgst_fire_per) / 100);
        var sgst_fire_tot = Math.round((fire_rate_after_discount_tot * sgst_fire_per) / 100);
        ...
        var final_paybal_premium = parseInt(fire_rate_after_discount_tot) + parseInt(cgst_fire_tot) + parseInt(sgst_fire_tot);
