<div class="form-group row">
    <table class="table mb-0 table-bordered col-md-12">
        <tr>
            <td width="45%"><strong id="policy_title"> Stop Marine Policy Insured : </strong></td>
    ...
    <table class="table mb-0 table-bordered mt-2 col-md-12">
        ...
        <tr>
            <td colspn=""><strong> Rate Applied Per Rs.100</strong></td>
            <td colspn=""><strong><input type="number" name="rate_applied_per" id="rate_applied_per" value="" class="form-control" onkeyup="get_applied_rate_per_tot_sum_insured()"></strong></td>
