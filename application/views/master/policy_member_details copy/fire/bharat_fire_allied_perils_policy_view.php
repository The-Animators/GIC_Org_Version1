    ...
    <div class="col-md-10">
        <table class="table mb-0 table-bordered">
            ...
            <tr>
                ...
                <td><strong>
                        <input type="number" name="stfi_rate_per" id="stfi_rate_per" value="" class="form-control" onkeyup="get_total_stfi_rate()">
                    </strong></td>
                <td><strong>
                        <input type="number" name="stfi_rate_total" id="stfi_rate_total" value="" class="form-control">
                    </strong></td>
            </tr>
            <tr>
                <td colspan=""><strong>
                ...
                <td><strong>
                        <input type="number" name="earthquake_rate_per" id="earthquake_rate_per" value="" class="form-control" onkeyup="get_total_earthquake_rate()">
                    </strong></td>
                <td><strong>
                        <input type="number" name="earthquake_rate_total" id="earthquake_rate_total" value="" class="form-control">
                    </strong></td>
            </tr>
            <tr>
                <td colspan=""><strong>
                ...
                <td><strong>
                        <input type="number" name="terrorisum_rate_per" id="terrorisum_rate_per" value="" class="form-control" onkeyup="get_total_terrorisum_rate()">
                    </strong></td>
                <td><strong>
                        <input type="number" name="terrorisum_rate_total" id="terrorisum_rate_total" value="" class="form-control">
                    </strong></td>
            </tr>
            ...
            <tr>
                ...
                <td><strong>
                        ...
                        <input type="hidden" name="fire_allied_perils_policy_id" id="fire_allied_perils_policy_id" value="" class="form-control">
                        <input type="hidden" name="tot_sum_devid" id="tot_sum_devid" value="" class="form-control">
                    </strong></td>
            </tr>
        </table>
    </div>
...
<script>
    ...
    function get_total_fire() {
        ...
        var tot_sum_devid = Math.round(total_sum_assured / 1000);
        ...
        get_total_discount();
        get_total_stfi_rate();
        get_total_earthquake_rate();
        get_total_terrorisum_rate();
        gross_premium();
    }
    ...
    function get_total_stfi_rate(tot_sum_devid) {
        ...
        if (isNaN(fire_rate_after_discount_tot))
            fire_rate_after_discount_tot = 0;
        else
            fire_rate_after_discount_tot = fire_rate_after_discount_tot;

        if (isNaN(stfi_rate_per))
            stfi_rate_per = 0;
        else
            stfi_rate_per = stfi_rate_per;

        var stfi_rate_total = Math.round((stfi_rate_per * tot_sum_devid) / 100);

        $("#stfi_rate_total").val(stfi_rate_total);
        gross_premium();
        gst_apply();
    }

    function get_total_earthquake_rate(tot_sum_devid) {
        var tot_sum_devid = $("#tot_sum_devid").val();
        var fire_rate_after_discount_tot = $("#fire_rate_after_discount_tot").val();
        ...
        if (isNaN(earthquake_rate_per))
            earthquake_rate_per = 0;
        else
            earthquake_rate_per = earthquake_rate_per;

        var earthquake_rate_total = Math.round((earthquake_rate_per * tot_sum_devid) / 100);

        $("#earthquake_rate_total").val(earthquake_rate_total);
        gross_premium();
        gst_apply();
    }

    function get_total_terrorisum_rate(tot_sum_devid) {
        var tot_sum_devid = $("#tot_sum_devid").val();
        var fire_rate_after_discount_tot = $("#fire_rate_after_discount_tot").val();
        ...
        if (isNaN(terrorisum_rate_per))
            terrorisum_rate_per = 0;
        else
            terrorisum_rate_per = terrorisum_rate_per;

        var terrorisum_rate_total = Math.round((terrorisum_rate_per * tot_sum_devid) / 100);

        $("#terrorisum_rate_total").val(terrorisum_rate_total);
        gross_premium();
        gst_apply();
    }
    ...
    function gross_premium() {
        ...
        if (isNaN(stfi_rate_total))
            stfi_rate_total = 0;
        else
            stfi_rate_total = stfi_rate_total;

        if (isNaN(earthquake_rate_total))
            earthquake_rate_total = 0;
        else
            earthquake_rate_total = earthquake_rate_total;

        if (isNaN(terrorisum_rate_total))
            terrorisum_rate_total = 0;
        else
            terrorisum_rate_total = terrorisum_rate_total;

        var gross_premium = parseInt(stfi_rate_total) + parseInt(earthquake_rate_total) + parseInt(terrorisum_rate_total)+parseInt(fire_rate_after_discount_tot);
        if(gross_premium !="")
        $("#gross_premium").val("");
    ...
    function gst_apply() {
        ...
        if (fire_rate_per == "") {
            $("#fire_rate_tot").val(0);
            $("#less_discount_tot").val(0);
            $("#fire_rate_after_discount_tot").val(0);
            $("#stfi_rate_total").val(0);
            $("#earthquake_rate_total").val(0);
            $("#terrorisum_rate_total").val(0);
            $("#gross_premium").val(0);
            $("#cgst_fire_tot").val(0.0);
            $("#sgst_fire_tot").val(0.0);
            $("#final_paybal_premium").val(0);
        }
