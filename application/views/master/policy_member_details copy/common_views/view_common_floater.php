    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            <tr id="declaration_sale_fig_tr">
                ...
                <td><center><strong id="comm_float_total_amount"></strong></center></td>
            </tr>
            <tr id="annual_turn_over_tr">
                <td colspn=""><strong> Less Discount: </strong></td>

                <td colspn=""><center><strong id="comm_float_less_discount_rate"></strong></center></td>
                <td><center><strong id="comm_float_less_discount_tot"></strong></center></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong>Add Loading: </strong></td>
                <td colspn=""><center><strong id="comm_float_load_desc"></strong></center></td>
                <td><center><strong id="comm_float_load_tot"></strong></center></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong>Premium After Loading/Gross Premium: </strong></td>
                <td colspn=""><strong></strong></td>
                <td><center><strong id="comm_float_gross_premium"></strong></center></td>
            </tr>
            <tr>
                <td colspn=""><strong> CGST:</strong></td>
                <td><center><strong id="cgst_fire_per"></strong></center></td>
                <td><center><strong id="comm_float_cgst_tot"></strong></center></td>
            </tr>
            <tr>
                <td><strong> SGST</strong></td>
                <td><center><strong id="sgst_fire_per"></strong></center></td>
                <td><center><strong id="comm_float_sgst_tot"></strong></center></td>
            </tr>
            <tr>
                <td colspn="3"><strong class="text-purple">Final Premium</strong></td>
                <td colspn="2"><strong></strong></td>
                <td><center><strong id="comm_float_final_premium" class="text-purple"></strong></center></td>
            </tr>
        </table>
    </div>
</div>
