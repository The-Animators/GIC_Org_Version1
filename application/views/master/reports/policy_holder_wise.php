                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 row">
                                            <label for="filter_member" class="col-form-label col-md-4 text-right">Policy Holder : </label>
                                            <div class="col-md-8">
...
<script>
    ...
    function Filter_data() {
        ...
        var url = "<?php echo $base_url; ?>master/reports/filter_policy_holder";
                    ...
                    if (data["status"] == true) {
                        ...
                        $.each(data, function(key, val) {
                            ...
                            if (!isNaN(policy_id)) {
                                ...
                                total_serial_no
                                datas += '<tr onmouseover="ChangeBackgroundColor(this)" onmouseout="RestoreBackgroundColor(this)"><td>' + sn + '</td><td>' + total_serial_no + '</td><td><center>' + grpname + '</center></td><td><center>' + member_name + '</center></td><td>' + policy_type_title + '</td><td>' + policy_no + '</td><td width="10%">' + date_from + '</td><td width="10%">' + date_to + '</td><td>' + company_name + '</td><td>' + department_name + '</td> </tr>';
                            }
                        });
                    } else {
                        $("#tableData").empty();
