                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        ...
                                        <div class="col-md-4 row">
                                            ...
                                            <div class="col-md-8">
                                                <select name="filter_group" id="filter_group" onchange="group_member()" class="form-control" data-toggle="select2">
                                        ...
                                        <div class="col-md-4 row mt-1">
                                            <label for="filter_member" class="col-form-label col-md-5 text-right">Member : </label>
                                            <div class="col-md-7">
                                                <select name="filter_member" id="filter_member" class="form-control" data-toggle="select2">
                                                    <option value="null">Select Member Name</option>
                                                </select>
                                            </div>
                                        </div>
...
<script>
    ...
    function Filter_data() {
        ...
        var url = "<?php echo $base_url; ?>master/reports/filter_member_wise";
                ...
                success: function(data) {
                    ...
                    if (data["status"] == true) {
                        ...
                        $.each(data, function(key, val) {
                            ...
                            member_name_str_arr = data[key].member_name_str_arr;
                            ...
                            if (!isNaN(policy_id)) {
                                ...
                                total_serial_no
                                datas += '<tr onmouseover="ChangeBackgroundColor(this)" onmouseout="RestoreBackgroundColor(this)"><td>' + sn + '</td><td>' + total_serial_no + '</td><td><center>' + member_name_str_arr + '</center></td><td>' + grpname + '</td><td>' + member_name + '</td><td>' + policy_type_title + '</td><td>' + policy_no + '</td><td width="10%">' + date_from + '</td><td width="10%">' + date_to + '</td><td>' + company_name + '</td><td>' + department_name + '</td> </tr>';
                            }
                        });
                    } else {
                        $("#tableData").empty();
    ...
    function Reset_data() {
        ...
        $("#filter_member").val("null");
        $("#filter_group").prop('selectedIndex', 0);
        $("#filter_member").prop('selectedIndex', 0);
        get_group_wise_list();
    }
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        ...
                        $('#filter_member').html("<option value='null'>Select Member Name</option>");
                        var option_val = "";
                    ...
                    $('#filter_member').append(option_val);
                },
                error: function(xhr, status) {
                    alert('Sorry, there was a problem!');
                },
