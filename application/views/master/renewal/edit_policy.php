                            ...
                            <div class="form-row mt-2">
                                ...
                                <div class="form-group col-md-5">
                                    <center>
                                        ...
                                        <button id="update" class="btn btn-primary btn-xs">Update</button>
...
<script>
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        ...
                        if(data["userdata"].policy_type == 1){
                            ...
                            }else if(((company_txt == "Max Bupa Health Insurance Co Ltd") || (company_txt == "Niva Bupa Health Insurance Co Ltd")) && data["userdata"].policy_type_title == "Mediclaim"){
                        ...
                        if (!isNaN(policy_id)) {
                            ...
                            var back_btn = '<a href="<?php echo base_url() . "master/policy"; ?>" class="btn btn-secondary waves-effect width-md btn-xs">Back</a>';
    ...
    function edit_GPA(gpa_ind_data_arr){
        ...
        $.each(tot_gpa_json_data, function(key, val) {
            ...
            if (gpa_excel_attach_file == "" || gpa_excel_attach_file == null) {
                ...
                var download_gpa_excel_attach = "<a href='<?php echo base_url(); ?>master/remote/download_doc/2/1/"+ gpa_excel_attach_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
    ...
    $("#update").click(function() {
        ...
        var url = "<?php echo $base_url; ?>master/renewal/updatepolicy";
        ...
        $.ajax({
            ...
            success: function(data) {
                if (data["status"] == true) {
                    ...
                    $("#serial_no").removeClass("parsley-error");
                    setTimeout(function() {
                        window.location.href = '<?php echo base_url(); ?>master/renewal/index2';
                    }, 1000);
                } else {
                    if (data["messages"] != "") {
