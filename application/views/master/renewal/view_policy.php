                ...
                <div class="col-12">
                    <div class="card-box table-responsive">
                        <div class="row">
                            ...
                            <div class="col-md-6 text-right" id="btn_details"> </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <table class="table ml-1 mb-1 table-bordered">
                                            <thead>
                                                <tr>
                                ...
                                <div class="form-row " id="append_risk"></div>
...
<script>
    ...
    function edit_Risk_details(risk_details, type) {
        ...
        if (type == 1) { // 1:Individual , 2:Floater
            var html = '<u><strong>Risk Details</strong></u><table class="table mb-1 table-bordered col-md-12"><tr><td><strong><center>Address</center></strong></td><td><strong><center>Description</center></strong></td><td><strong><center>Sum Assured</center></strong></td>';
            ...
            var html_details = '';
            var html_risk = '<div class="col-md-6"><u><strong>Risk Details</strong></u><table class="table mb-1 table-bordered"><tr><td><strong><center>Address</center></strong></td></tr>';
            $.each(risk_details, function(key1, val1) {
                ...
                html_risk += '</table></div><div class="col-md-6"><table class="table mb-1 table-bordered"><tr><td><strong><center>Description</center></strong></td><td><strong><center>Sum Assured</center></strong></td>';
    ...
    function OnDelete_Doc(policy_details) {
        ...
        if(doc_type==1)
            var title = "Renewable Policy Upload Document";
        else if(doc_type==2)
            var title = "Renewable Quotation Upload Document";
                    ...
                    if (data["status"] == true) {
                        ...
                        if (!isNaN(policy_id)) {
                            ...
                            if (current_date <= expiry_date) {
                                ...
                                renew_btn = " <a id='renew' href='<?php echo base_url() . "master/renewal/renew_policy/"; ?>" + policy_id + "' class='btn btn-facebook btn-xs mr-1 edit' id='edit'>Renew</a>";
                            }

                            var edit_btn = " <a id='edit' href='<?php echo base_url() . 'master/renewal/editpolicy/'; ?>" + policy_id + "' class='btn btn-facebook btn-xs mr-1 edit' id='edit'><i class='fas fa-pencil-alt'></i></a><button id='delete' onclick='OnDelete(" + policy_id + ")' class='btn btn-danger btn-xs mr-1 delete'><i class='fa fa-trash'></i></button><button id='recover' onclick='OnRecover(" + policy_id + ")' class='btn btn-primary btn-xs mr-1' style='display:none;'><i class='fa fa-undo'></i></button>";
    ...
    function edit_GMC(gmc_ind_data_arr){
        ...
        $.each(tot_gmc_json_data, function(key, val) {
            ...
            if (gmc_excel_attach_file == "" || gmc_excel_attach_file == null) {
                ...
                var view_gmc_excel_attach = "<span >"+gmc_excel_attach_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/1/"+ gmc_excel_attach_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
            ...
            if (gmc_attach_quote_file == "" || gmc_attach_quote_file == null) {
                ...
                var view_gmc_attach_quote = "<span >"+gmc_attach_quote_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/2/"+ gmc_attach_quote_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
            ...
            if (gmc_attach_endorsment_copy_file == "" || gmc_attach_endorsment_copy_file == null) {
                ...
                var view_gmc_attach_endorsment_copy = "<span >"+gmc_attach_endorsment_copy_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/3/"+ gmc_attach_endorsment_copy_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
    ...
    function edit_GPA(gpa_ind_data_arr){
        ...
        $.each(tot_gpa_json_data, function(key, val) {
            ...
            if (gpa_excel_attach_file == "" || gpa_excel_attach_file == null) {
                ...
                var view_gpa_excel_attach = "<span >"+gpa_excel_attach_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/1/"+ gpa_excel_attach_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
                var download_gpa_excel_attach = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/1/"+ gpa_excel_attach_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
            if (gpa_attach_quote_file == "" || gpa_attach_quote_file == null) {
                ...
                var view_gpa_attach_quote = "<span >"+gpa_attach_quote_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/2/"+ gpa_attach_quote_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
                var download_gpa_attach_quote = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/2/"+ gpa_attach_quote_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
            if (gpa_attach_endorsment_copy_file == "" || gpa_attach_endorsment_copy_file == null) {
                ...
                var view_gpa_attach_endorsment_copy = "<span >"+gpa_attach_endorsment_copy_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/3/"+ gpa_attach_endorsment_copy_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
                var download_gpa_attach_endorsment_copy = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/3/"+ gpa_attach_endorsment_copy_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
    ...
    function edit_Payment_Acknowledge_details(total_paymentacknowledge_data){
        ...
        $.each(total_paymentacknowledge_data, function(key1, val1) {
            ...
            if (payment_acknowledgement_file == "" || payment_acknowledgement_file == null) {
                ...
                var view_payment_acknowledgement = "<span >"+payment_acknowledgement_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/3/1/"+ payment_acknowledgement_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></b></a>";
    ...
    function OnRecover(policy_id) {
        ...
        confirmation_alert(id = policy_id, url = url, title = "Renewable Policy Details", type = "Recover");
    }

    function OnDelete(policy_id) {
        var url = "<?php echo $base_url; ?>master/renewal/removepolicy";
        confirmation_alert(id = policy_id, url = url, title = "Renewable Policy Details", type = "Delet");
    }
                ...
                success: function(data) {
                    ...
                    if (data["status"] == true) {
                        ...
                        if (data["userdata"]["policy_member_status"] == 1) {
                            status = "In-Active";
                            var status_btn_txt = "btn btn-outline-danger waves-effect waves-light edit";
                            $("#edit_" + policy_id).addClass(status_btn_txt);
                            $("#status_btn_" + policy_id).text(status);
                        } else {
                            status = "Active";
                            var status_btn_txt = "btn btn-outline-success waves-effect waves-light edit";
                            $("#edit_" + policy_id).addClass(status_btn_txt);
                            $("#status_btn_" + policy_id).text(status);
                        }
