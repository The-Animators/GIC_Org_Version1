                            ...
                            <div class="row">
                                <div class="col-md-12">
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-4">
                                            <center>
                                                <button id="submit_description" onclick="DescriptionSave()" class="btn btn-primary btn-xs">Save</button>
                                            </center>
                                        </div>
                    ...
                    <div class="card-box table-responsive">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <a href="<?php echo base_url() . "master/renewal/index2"; ?>" class='btn btn-secondary waves-effect btn-xs'>Back</a>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group row">
                                            <label for="pre_year_policy_no" class="col-form-label col-md-4 text-right">Previous Policy No.<span class="text-danger">*</span></label>
                                            <div class="col-md-8">
                                                <input type="text" name="pre_year_policy_no" id="pre_year_policy_no" value="" placeholder="Enter Previous Policy No." class="form-control">
                                                <span id="pre_year_policy_no_err"></span>
                                            </div>
                                        </div>
                                    </div>
                            ...
                            <div class="form-row" id="risk_rc">
                                ...
                                <div class="col-md-6 text-right" id="risk_button_rc">
                                    <button class="btn btn-primary btn-xs addRisc_R_C" id="addRisc_R_C" onclick="addRisc_R_C()">Add Risk Address</button>
                                </div>
                            </div>
                            ...
                            <div class="form-row" id="risk_individual">
                                ...
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddRisk" id="AddRisk" onClick="AddRisk()" disabled>Add Risk Address</button>
                                    <input class='btn btn-facebook btn-xs' id='add_description' value=' Add Description' type='button' disabled>
                                </div>
                            </div>
                            ...
                            <div class="form-row" id="risk_floater">
                                ...
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddRiskFloater" id="AddRiskFloater" onClick="AddRiskFloater()">Add Risk Address</button>

                                </div>
                            </div>

                            <div class=" " id="append_risk"></div>

                            <div class="form-row mt-2" id="risk_floater_add">
                                <div class="col-md-6"> </div>
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddRiskDetails_floater" id="AddRiskDetails_floater" onClick=AddRiskDetails_floater(0)>Add Risk</button>
                                    <input class='btn btn-facebook btn-xs' id='add_description_floater' value='Add Description' type='button'>
                                </div>
                                <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddRemark" id="AddRemark" onClick="AddRemark(0)">Add Remark</button></div>
                            </div>
                            ...
                            <span style="display:none;" id="hypotication_details_global" >
                                <div class="form-row">
                                    ...
                                    <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddHypotication" id="AddHypotication" onClick="AddHypotication(0)">Add Hypotication</button></div>
                                </div>
                                <hr class="mt-2">
                                <div class="form-row">
                                    <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs AddCorrespondence" id="AddCorrespondence" onClick="AddCorrespondence(0)">Add Correspondence</button></div>
                            </div>
                            <hr class="mt-2">
                            <div class="form-row">
                                <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-md-6 text-right"><button class="btn btn-primary btn-xs  Add_PaymentAcknowledgement" id="Add_PaymentAcknowledgement" onClick="AddPaymentAcknowledgement(0)">Add Payment Acknowledgement</button></div>
                            </div>
                            <hr class="mt-2">
                            <div class="form-row">
                                <div class="col-md-12">
...
<script>
    ...
    function AddRiskDetails_floater() {
        if (option_policyDescription_data == "") {
            var option_riskval = '<?php if (!empty($risk_description)) : foreach ($risk_description as $row) : ?><option value="<?php echo  $row["policy_description_id"]; ?>"><?php echo  ucwords($row["policy_description_name"]); ?></option><?php endforeach; endif; ?>';
        } else {
            var option_riskval = option_policyDescription_data;
        }
        $("#AddRiskDetails_floater").attr("onClick", "AddRiskDetails_floater(" + add_risk_desc + ")");
        var tr_table = ' <tr><td><select class="form-control risk_description" id="risk_description_' + add_risk_desc + '" name="risk_description[]"> <option value="null" >Select Description</option>' + option_riskval + '</select></td><td><input class="form-control risk_sum_assured" type="number" name="risk_sum_assured[]" id="risk_sum_assured_' + add_risk_desc + '" value="" placeholder="Risk Sum Assured" onkeyup="get_total_sum_Assured()"></td><td><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_details_floater_' + add_risk_desc + '" onClick=removeRiskDetails_Floater("' + add_risk_desc + '") ></td></tr>';
    ...
    function AddRiskDetails(add_risk_details) {
        ...
        var tr_table = '<div class="col-md-12 form-group row description"  id="description_' + tot_counter + '"><div class="col-md-5"><div class="form-group row"> <label for="risk_description" class="col-form-label col-md-5 text-right">Description</label> <div class="col-md-7"><select class="form-control risk_description" id="risk_description_' + tot_counter + '" name="risk_description[]"> <option value="null" >Select Description</option>' + option_riskval + '</select></div> </div> </div> <div class="col-md-5"><div class="form-group row"> <label for="risk_sum_assured" class="col-form-label col-md-4 text-right">Sum Assured</label> <div class="col-md-8"><input class="form-control risk_sum_assured" type="number" name="risk_sum_assured[]" id="risk_sum_assured_' + tot_counter + '" value="" placeholder="Risk Sum Assured" onkeyup="get_total_sum_Assured()"></div> </div> </div> <div class="col-md-2"><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_details_' + tot_counter + '" onClick=removeRiskDetails("' + tot_counter + '") > </div></div></div>';
    ...
    function getRemarkDetails(policy_id) {
        ...
        $("#append_remark").empty();
        var url = "<?php echo $base_url; ?>master/renewal/get_remarks_details";
        if (url != "") {
            $.ajax({
                url: url,
                data: {
                ...
                success: function(data) {
                    ...
                    if (data["status"] == true) {
                        ...
                        $.each(remark, function(key, val) {
                            ...
                            remark_tr += ' <tr><td style="border: 1px solid #dddddd;"><textarea rows="5" name="remarks[]" id="remarks_' + add_remark + '" value="" placeholder="Enter Remarks" class="form-control remarks">' + remarks + '</textarea></td><td style="border: 1px solid #dddddd;"><input type="date" name="male_date[]" id="male_date_' + add_remark + '" value="' + male_date + '" placeholder="Enter Mail Date" class="form-control male_date"></td> <td style="border: 1px solid #dddddd;"><input type="hidden" name="policy_remark_id[]" id="policy_remark_id_' + add_remark + '" value="' + policy_remark_id + '"  class="policy_remark_id"><button class="btn btn-primary btn-xs dripicons-cross" id="remove_remark_' + add_remark + '" onClick="removeRemark(' + add_remark + ')" data-value="' + policy_remark_id + '" data-id="' + policy_remark_id + '"></button></td> </tr>';
                        });
    ...
    function getPOLICYDetails() {
        ...
        var url = "<?php echo $base_url; ?>master/renewal/edit_policy";
        if (url != "") {
            $.ajax({
                url: url,
                data: {
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        ...
                        // New Master Sub pOlicy Name Secion Start
                        if((data["userdata"].fk_company_id != "" || data["userdata"].fk_company_id !="null" || data["userdata"].fk_company_id != undefined) && (data["userdata"].fk_department_id != "" || data["userdata"].fk_department_id !="null" || data["userdata"].fk_department_id != undefined) && (data["userdata"].fk_policy_type_id != "" || data["userdata"].fk_policy_type_id !="null" || data["userdata"].fk_policy_type_id != undefined)){
                                
                                get_sub_policy_details();
                                $('select[id^="policy_type"] option[value="' + data["userdata"].policy_type + '"]').attr("selected", "selected");
                                if(data["userdata"].policy_type == 5 || data["userdata"].policy_type == 4){
                                    $("#sub_policy_name_textbox_div").show();
                                    $("#sub_policy_name_txt_box").val(data["userdata"].floater_policy_type);
                                }else{
                                    get_sub_policy_names();
                                    $('select[id^="sub_policy_name"] option[value="' + data["userdata"].floater_policy_type + '"]').attr("selected", "selected");
                                    if(data["userdata"].floater_policy_type != "" || data["userdata"].floater_policy_type != "null" || data["userdata"].floater_policy_type != undefined){
                                        get_family_size_child();
                                        $('select[id^="sub_policy_family_size"] option[value="' + data["userdata"].family_size + '"]').attr("selected", "selected");
                                        $('select[id^="sub_policy_add_child"] option[value="' + data["userdata"].addition_of_more_child + '"]').attr("selected", "selected");
                                    }
                                }   
                            }
                        // New Master Sub pOlicy Name Secion End
                        Policy_typeName();
                        ...
                        $("#pre_year_policy_no").val(data["userdata"].policy_no);
                        $("#policy_no").val("");
                        var company_txt = $("#company option:selected").text();
                        ...
                        if((data["userdata"].policy_type == 1) && (data["userdata"].policy_type_title=="Super Top Up" || data["userdata"].policy_type_title=="Top Up" || data["userdata"].policy_type_title=="Critical illness")){
                            if (data["userdata"].policy_type != 3) {
                                if (company_txt == "HDFC ERGO HEALTH INSURANCE LTD" || company_txt == "HDFC Ergo General Insurance Co Ltd") {
                        ...
                        if((data["userdata"].policy_type ==2) && (data["userdata"].policy_type_title=="Super Top Up" || data["userdata"].policy_type_title=="Top Up" || data["userdata"].policy_type_title=="Critical illness")){
                            if (data["userdata"].policy_type != 3) {
                                if (company_txt == "HDFC ERGO HEALTH INSURANCE LTD" || company_txt == "HDFC Ergo General Insurance Co Ltd") {
                                    $("#hdfc_ergo_health_insu_supertopup_float_family_size").val(data["userdata"].family_size);
                        ...
                        if((data["userdata"].policy_type == 4) && (data["userdata"].policy_type_title=="Super Top Up" || data["userdata"].policy_type_title=="Top Up" || data["userdata"].policy_type_title=="Critical illness")){
                            if (data["userdata"].policy_type != 3) {
                                var supertopup_ind_data_arr = data["userdata"].supertopup_ind_data_arr;
                                console.log(supertopup_ind_data_arr);
                                edit_supertopup_Individual_policy(supertopup_ind_data_arr,data["userdata"].policy_type);
                        ...
                        if((data["userdata"].policy_type ==5) && (data["userdata"].policy_type_title=="Super Top Up" || data["userdata"].policy_type_title=="Top Up" || data["userdata"].policy_type_title=="Critical illness")){
                            if (data["userdata"].policy_type != 3) {
                                family_Size_Val(data["userdata"].family_size);
                                $("#family_size").val(data["userdata"].family_size);
                                var supertopup_floater_data_arr = data["userdata"].supertopup_floater_data_arr;
                        ...
                        if (!isNaN(policy_id)) {
                            if (policy_member_status == 1) {
                                var status = "Active";
                                var status_btn_txt = "btn btn-outline-success waves-effect width-md waves-light btn-xs edit";
                            } else {
                                var status = "In-Active";
                                var status_btn_txt = "btn btn-outline-danger waves-effect width-md waves-light btn-xs edit";
                            }

                            var edit_btn = " <a id='edit' href='<?php echo base_url() . "master/policy/edit_policy/"; ?>" + policy_id + "' class='btn btn-facebook btn-xs mr-1 edit' id='edit'>Edit Policy</a><button id='delete' onclick='OnDelete(" + policy_id + ")' class='btn btn-primary btn-xs mr-1 delete'>Delete <?php echo $title; ?></button><button id='recover' onclick='OnRecover(" + policy_id + ")' class='btn btn-primary btn-xs mr-1' style='display:none;'>Recover <?php echo $title; ?></button>";
                            ...
                            var back_btn = '<a href="<?php echo base_url() . "master/renewal/index2"; ?>" class="btn btn-secondary waves-effect btn-xs">Back</a>';
    ...
    function edit_medi_ind_care_health_care_adv_ind_policy(care_health_care_adv_ind_policy_data_arr){
        ...
        $.each(total_care_adv_ind_json_data, function(key, val) {
            ...
            // if(name_insured_age!=""){
            //     name_insured_dob = tot_supertopup_ind_json[key][3];
            //     name_insured_dob= name_insured_dob.split("-");
            //     dob = new Date(name_insured_dob[2]+"-"+name_insured_dob[1]+"-"+name_insured_dob[0]);
            //     var today = new Date();
    ...
    function edit_GMC(gmc_ind_data_arr){
        ...
        $.each(tot_gmc_json_data, function(key, val) {
            ...
            if (gmc_excel_attach_file == "" || gmc_excel_attach_file == null) {
                ...
                var view_gmc_excel_attach = "<span >"+gmc_excel_attach_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/1/"+ gmc_excel_attach_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_gmc_excel_attach = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/1/"+ gmc_excel_attach_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
            if (gmc_attach_quote_file == "" || gmc_attach_quote_file == null) {
                ...
                var view_gmc_attach_quote = "<span >"+gmc_attach_quote_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/2/"+ gmc_attach_quote_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_gmc_attach_quote = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/2/"+ gmc_attach_quote_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
            if (gmc_attach_endorsment_copy_file == "" || gmc_attach_endorsment_copy_file == null) {
                ...
                var view_gmc_attach_endorsment_copy = "<span >"+gmc_attach_endorsment_copy_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/1/3/"+ gmc_attach_endorsment_copy_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_gmc_attach_endorsment_copy = "<a href='<?php echo base_url(); ?>master/remote/download_doc/1/3/"+ gmc_attach_endorsment_copy_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
    ...
    function edit_GPA(gpa_ind_data_arr){
        ...
        $.each(tot_gpa_json_data, function(key, val) {
            ...
            if (gpa_excel_attach_file == "" || gpa_excel_attach_file == null) {
                ...
                var view_gpa_excel_attach = "<span >"+gpa_excel_attach_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/2/1/"+ gpa_excel_attach_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
            ...
            if (gpa_attach_quote_file == "" || gpa_attach_quote_file == null) {
                ...
                var view_gpa_attach_quote = "<span >"+gpa_attach_quote_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/2/2/"+ gpa_attach_quote_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_gpa_attach_quote = "<a href='<?php echo base_url(); ?>master/remote/download_doc/2/2/"+ gpa_attach_quote_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
            if (gpa_attach_endorsment_copy_file == "" || gpa_attach_endorsment_copy_file == null) {
                ...
                var view_gpa_attach_endorsment_copy = "<span >"+gpa_attach_endorsment_copy_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/2/3/"+ gpa_attach_endorsment_copy_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_gpa_attach_endorsment_copy = "<a href='<?php echo base_url(); ?>master/remote/download_doc/2/3/"+ gpa_attach_endorsment_copy_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
    ...
    function edit_supertopup_Individual_policy(supertopup_ind_data_arr,policy_type){
        ...
        $.each(tot_supertopup_ind_json, function(key, val) {
            ...
            $("#name_insured_member_name_"+add_supertopup_counter).val(name_insured_member_name);
            $("#name_insured_relation_"+add_supertopup_counter).val(name_insured_relation);
            $("#name_insured_policy_type_"+add_supertopup_counter).val(name_insured_policy_type);
            $("#name_insured_policy_option_"+add_supertopup_counter).val(name_insured_policy_option);
            $("#nominee_name_"+add_supertopup_counter).val(nominee_name);
            $("#nominee_relation_"+add_supertopup_counter).val(nominee_relation);
            if(policy_type==4){
                name_insured_dob = tot_supertopup_ind_json[key][3];
                name_insured_dob= name_insured_dob.split("-");
                dob = new Date(name_insured_dob[2]+"-"+name_insured_dob[1]+"-"+name_insured_dob[0]);
    ...
    function edit_supertopup_floater_policy(supertopup_floater_data_arr,policy_type){
        ...
        $("#Add_Common_SupperFloat").attr("onClick", "AddCommonSupperFloat(" + Family_size_count + ")");
        ...
        $.each(tot_supertopup_floater_json, function(key, val) {
            ...
            var nominee_name = tot_supertopup_floater_json[0][13];
            var nominee_relation = tot_supertopup_floater_json[0][14];
            name_insured_dob = tot_supertopup_floater_json[key][3];
            if(policy_type==2){
    ...
    function edit_medi_float_Suraksha_policy_HDFC_ERGO_HEALTH_INSURANCE_LTD(medi_float_suraksha_hdfc_ergo_health_insu_policy_data_arr){
        ...
        $.each(total_suraksha_float_medi_hdfc_json_data, function(key, val) {
            ...
            var ncb_tot_sum_insured = total_suraksha_float_medi_hdfc_json_data[0][18];
    ...
    function edit_medi_ind_HDFC_ERGO_HEALTH_INSURANCE_LTD_Optima_restore_policy(medi_ind_hdfc_ergo_health_insu_policy_data_arr){
        ...
        $.each(total_medi_ind_hdfc_json_data, function(key, val) {
            ...
            var ncb_tot_sum_insured = total_medi_ind_hdfc_json_data[key][24];
    ...
    function edit_medi_float_HDFC_ERGO_HEALTH_INSURANCE_LTD_Optima_restore_policy(medi_float_hdfc_ergo_health_insu_policy_data_arr){
        ...
        $.each(total_medi_float_hdfc_json_data, function(key, val) {
            ...
            var ncb_tot_sum_insured = total_medi_float_hdfc_json_data[0][21];
    ...
    function edit_marine_policy(marine_policy_data_arr) {
        ...
        $.each(total_marine_cc_json_data, function(key, val) {
            ...
            marine_cc_tr += '<tr><td><input type="text" class="form-control marine_cc" id="marine_cc_' + index + '" name="marine_cc[]" value="' + marine_cc_name + '"></td><td><button class="btn btn-primary btn-xs dripicons-cross" id="remove_marine_cc_' + index + '" onClick=removeMarine_cc("' + index + '") ></td></tr>';
        });

        $("#addsingle_marine_"+index).attr("onClick", "addsingle_Marine('" + (marine_cc_length) + "')");
        $("#append_marine_cc").append(marine_cc_tr);
        var plus_btn = '<button class="btn btn-primary btn-xs dripicons-plus  mt-2" id="addsingle_marine_' + index + '" onClick=addsingle_Marine("' + index + '") >';
            ...
            $.each(risk_rc_details, function(key1, val1) {
                ...
                $.each(risk_discr_arr_data, function(key2, val2) {
                    ...
                    if (parseInt(risk_discr_key[0]) == val1[0]) {
                        ...
                        mainRiskRCDescription.push(removeRiskIDS);
                        tr_rc_description += '<tr><td><input type="text" class="form-control" id="description_' + risk_key + '" name="description[]" value="' + risk_discr_name + '"></td><td><input type="number" class="form-control" id="nos_' + risk_key + '" name="nos[]"  onkeyup=Get_total_sum_assured("' + removeRiskIDS + '")  value="' + risk_discr_nos + '"></td><td><input type="number" class="form-control" id="value_' + risk_key + '" name="value[]"  onkeyup=Get_total_sum_assured("' + removeRiskIDS + '")  value="' + risk_discr_value + '"></td><td><input type="number" class="form-control" id="sum_assured_' + risk_key + '" name="sum_assured[]" value="' + risk_discr_sum_insured + '" ></td><td><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_r_c_' + risk_key + '" onClick=removeRisk_R_C("' + removeRiskIDS + '") ></td></tr>';
                    }

                });

                $("#addRisc_R_C").attr("onClick", "addRisc_R_C('" + (risk_rc_details_length) + "')");
                var tr_table = ' <div id="div_' + add_risk_RC + '" ><hr class="mt-2"><div class="form-row"> <div class="col-md-12"> <div class="form-group row"> <label for="risk_address" class="col-form-label col-md-2 text-right">Risk Address ' + (add_risk_RC + 1) + '</label> <div class="col-md-9"> <input class="form-control risk_address" type="text" name="risk_address[]" id="risk_address_' + add_risk_RC + '" value="' + risk_add_name + '" placeholder="Risk Address ' + (add_risk_RC + 1) + '"></div><div class="col-md-1"><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_' + add_risk_RC + '" onClick="removeRisk_RC(' + add_risk_RC + ')" > </div> </div></div><div class="col-md-12"> <div  id="r_c_append_' + add_risk_RC + '"   ><table  class="table mb-0 table-bordered" id="append_rcDescription_' + add_risk_RC + '"><tr><td width="55%">Description</td><td>Nos.</td><td>Value</td><td>Sum Insured</td><td>Action</td></tr>' + tr_rc_description + '</table><button class="btn btn-primary btn-xs dripicons-plus  mt-2" id="addRiskDesc_R_C_' + removeRiskIDS + '" onClick=addRiskDesc_R_C("' + removeRiskIDS + '") ></div></div></div></div>';
                $("#append_risk").append(tr_table);
            });
        }
        ...
        if (type == 1) { // 1:Individual , 2:Floater
            ...
            $.each(risk_details, function(key1, val1) {
                ...
                $.each(risk_add_key2, function(key_1, val_1) {
                    ...
                    tr_risk_table += ' <div id="div_' + key_1 + '" ><hr class="mt-2"><div class="form-row"> <div class="col-md-12"> <div class="form-group row"> <label for="risk_address" class="col-form-label col-md-2 text-right">Risk Address ' + (key_1 + 1) + '</label> <div class="col-md-8">  <input class="form-control risk_address" type="text" name="risk_address[]" id="risk_address_' + key_1 + '" value="' + risk_add + '" placeholder="Risk Address ' + (key_1 + 1) + '"></div><div class="col-md-2"><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_' + key_1 + '" onClick="removeRiskFloater(' + key_1 + ')" > </div> </div></div></div></div>';
                });
                ...
                $.each(risk_add_name2, function(key2, val2) {
                    ...
                    tr_table += ' <tr><td><select class="form-control risk_description" id="risk_description_' + key2 + '" name="risk_description[]"> <option value="null" >Select Description</option>' + option_riskval + '</select></td><td><input class="form-control risk_sum_assured" type="number" name="risk_sum_assured[]" id="risk_sum_assured_' + key2 + '" value="' + risk_sum_insured + '" placeholder="Risk Sum Assured"  onkeyup="get_total_sum_Assured()"></td><td><button class="btn btn-primary btn-xs dripicons-cross" id="remove_risk_details_floater_' + key2 + '" onClick=removeRiskDetails_Floater("' + key2 + '") ></td></tr>';
                });
    ...
    function edit_Payment_Acknowledge_details(total_paymentacknowledge_data){
        ...
        $.each(total_paymentacknowledge_data, function(key1, val1) {
            ...
            if (payment_acknowledgement_file == "" || payment_acknowledgement_file == null) {
                ...
                var view_payment_acknowledgement = "<span >"+payment_acknowledgement_file+"</span><br><a href='<?php echo base_url(); ?>master/remote/view_doc/3/1/"+ payment_acknowledgement_file +"'  class='text-info'><b><i class='mdi mdi-eye mdi-18'></i></b></a>";
                var download_payment_acknowledgement = "<a href='<?php echo base_url(); ?>master/remote/download_doc/3/1/"+ payment_acknowledgement_file+"'  class='text-success'><b><i class='mdi mdi-cloud-download-outline mdi-18'></i></b></a>";
            }
    ...
    $("#update").click(function() {
        ...
        var pre_year_policy_no = $("#pre_year_policy_no").val();
        var group_name = $("#group_name").val();
        var policy_holder_name = $("#policy_holder_name").val();
        ...
        form_data.append('pre_year_policy_no', pre_year_policy_no);
        ...
        var url = "<?php echo $base_url; ?>master/policy/updatepolicy";
    ...
    function AddPaymentAcknowledgement(add_paymentacknowledge_counter) {
        ...
        var tr_table = '<tr style=""><td style="border: 1px solid #dddddd;"><select name="payment_mode[]" id="payment_mode_'+add_paymentacknowledge_counter+'" class="form-control payment_mode"><option value="null">Select Payment Mode</option><option value="Cheque">Cheque</option><option value="Online Payment Link">Online Payment Link</option><option value="NEFT / IMPS / RTGS">NEFT / IMPS / RTGS</option></select></td><td style="border: 1px solid #dddddd;"><input type="file" name="payment_acknowledgement_file[]" id="payment_acknowledgement_file_'+add_paymentacknowledge_counter+'" class="form-control payment_acknowledgement_file"><span id="payment_acknowledgement_file_err_'+add_paymentacknowledge_counter+'"></span><input type="hidden" id="payment_acknowledgement_file_hidden_'+add_paymentacknowledge_counter+'" name="payment_acknowledgement_file_hidden" class="payment_acknowledgement_file_hidden"></td><td style="border: 1px solid #dddddd;"><center><button class="btn btn-primary btn-xs dripicons-cross" id="payment_acknowledgement_'+add_paymentacknowledge_counter+'" onClick="RemovePaymentAcknowledgement('+add_paymentacknowledge_counter+')" ></button></center></td></tr>';
        $("#append_payment_acknowlege").append(tr_table);
        main_paymentacknowledge.push(add_paymentacknowledge_counter);
    ...
    function get_family_size_child() {
        ...
        if (sub_policy_name_txt == "Family Floater 2020")
            $("#3_cover_div").show();
        else
            $("#3_cover_div").hide();
