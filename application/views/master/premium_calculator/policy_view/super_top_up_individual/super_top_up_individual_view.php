        ...
        <table class="table mb-0 table-bordered" id="first_table">
            ...
            <tbody id="first_table_tbody">
                <!-- <tr>
                    ...
                    <td width="12%"><select style="width:110px;" id="name_insured_policy_option_0" name="name_insured_policy_option[]" class="form-control name_insured_policy_option" onchange="get_premium_thresold_sum_insured_basedOn_Age_Policy_Option(0)"><option value="null">Select Policy Option</option></select></td>
