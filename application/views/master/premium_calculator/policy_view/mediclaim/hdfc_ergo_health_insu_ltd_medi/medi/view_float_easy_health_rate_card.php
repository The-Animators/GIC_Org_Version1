    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr id="">
                ...
                <td><center><strong id="stay_active_benefit_prem"></strong></center></td>
            </tr>
            <tr id="">
                <td colspn="3"><strong> Long Term Premuim Discount : </strong></td>
                <td colspn="">
                    <div class="row">
                        <div class="col-md-5"><center><strong id="less_disc_per"></strong></center></div>
                        <div class="col-md-2"><center><strong id="">*</strong></center></div>
                        <div class="col-md-5"><center><strong id="tot_basic_prem"></strong></center></div>
                    </div>
                </td>
