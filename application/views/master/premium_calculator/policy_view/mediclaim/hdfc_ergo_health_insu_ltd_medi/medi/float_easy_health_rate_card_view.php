...
<script>
    ...
    function get_hospital_daily_cash_prem() {
        ...
        if (max_age != "" && hospital_daily_cash_per_day != ""  && hospital_daily_cash_per_day != "null" && condition_value != "" && hdfc_ergo_health_insu_family_size != "null" && hdfc_ergo_health_insu_family_size != "") {
    ...
    function get_basic_premium() {
        ...
        if (region != "null" && region != "" && type_of_policy != "null" && type_of_policy != "" && max_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && hdfc_ergo_health_insu_family_size != "null" && hdfc_ergo_health_insu_family_size != "") {
