...
<div class="col-md-6">
    ...
    <div class="col-md-12" style="overflow-x:auto;">
        <table class="table mb-0 table-bordered" id="first_table">
            <thead>
                <tr>
                    <th><button class="btn btn-primary btn-sm Add_supertopup_medi_HDFC" id="Add_supertopup_medi_HDFC" onclick="AddSuperTopUpMediHDFC(0)">Add</button></th>
    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="supertopup_ind_policy_id" name="supertopup_ind_policy_id" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    function Region_change(){
        ...
        // alert(flag);
        // if(flag==true)
            get_basic_premium_basedon_region(flag,main_supertopup_Medi_HDFC);
    }
    ...
    function get_sum_insured_dropdown(add_medi_hdfc_counter){
        var deductable = $("#deductable_"+add_medi_hdfc_counter).val();
        ...
        if(deductable != "null" || deductable !=""){
            ...
            $("#name_insured_sum_insured_"+add_medi_hdfc_counter).append('<option value="null">Select Sum Insured</option>'+deductable_sum_insured_dropdown_val);
        }
    }
    ...
    function Total_supertopup_ind_Medi_HDFC() {
    ...
    function get_basic_premium(add_medi_hdfc_counter) {
        ...
        if (deductable != "" && deductable != "null" && name_insured_sum_insured != "" && name_insured_sum_insured != "null" && name_insured_age != "" && condition_value != "" && condition_value1 != "") {
    ...
    function get_basic_premium_basedon_region(flag,main_supertopup_Medi_HDFC){
        if(flag==false){
            $.each(main_supertopup_Medi_HDFC, function(key, val) {
