    ...
    <div class="col-md-12" style="overflow-x:auto;">
        <table class="table mb-0 table-bordered" id="first_table">
            ...
            <!-- <tr>
                ...
                <td><input style="width:110px;" type="text" name="final_combine_cover_with_afterncd_premium[]" id="final_combine_cover_with_afterncd_premium_0" class="form-control final_combine_cover_with_afterncd_premium" value=""></td>
            </tr> -->
        </tbody>
...
<script>
    ...
    function Total_Mediclaim_indi2020() {
        ...
        $("#first_table tr:has(.name_insured_member_name)").each(function(key, val) {
            ...
            var final_combine_cover_with_afterncd_premium = $(".final_combine_cover_with_afterncd_premium", this).val();
    ...
    function name_insured_ncd_Cal(add_medi_counter2020) {
        ...
        final_combine_cover_with_afterncd_premium(add_medi_counter2020);
        medi2020_ncd_amount_Cal();
    ...
    function final_combine_cover_with_afterncd_premium_Cal(add_medi_counter2020){
        var inputs = $(".final_combine_cover_with_afterncd_premium");
        var total = 0;
        for (var i = 0; i < inputs.length; i++) {
            var final_combine_cover_with_afterncd_premium = $(inputs[i]).val();
            final_combine_cover_with_afterncd_premium = parseInt(final_combine_cover_with_afterncd_premium);
            if (isNaN(final_combine_cover_with_afterncd_premium))
            final_combine_cover_with_afterncd_premium = 0;
            else
            final_combine_cover_with_afterncd_premium = final_combine_cover_with_afterncd_premium;

            total = total + final_combine_cover_with_afterncd_premium;
            $("#medi_ind_2020_total_premium").val(total);
        }
        // final_combine_cover_with_afterncd_premium(add_medi_counter2020);
    }
    function final_combine_cover_with_afterncd_premium(add_medi_counter2020){
        var name_insured_premium_after_ncd = $("#name_insured_premium_after_ncd_"+add_medi_counter2020).val();
        var restore_cover_premium = $("#restore_cover_premium_"+add_medi_counter2020).val();
        var maternity_new_born_baby_cover_premium = $("#maternity_new_born_baby_cover_premium_"+add_medi_counter2020).val();
        var daily_cash_allowance_cover_premium = $("#daily_cash_allowance_cover_premium_"+add_medi_counter2020).val();
        name_insured_premium_after_ncd = parseInt(name_insured_premium_after_ncd);
        restore_cover_premium = parseInt(restore_cover_premium);
        maternity_new_born_baby_cover_premium = parseInt(maternity_new_born_baby_cover_premium);
        daily_cash_allowance_cover_premium = parseInt(daily_cash_allowance_cover_premium);
        var final_combine_cover_with_afterncd_premium = 0;
        ...
        daily_cash_allowance_cover_premium = daily_cash_allowance_cover_premium;
        final_combine_cover_with_afterncd_premium = parseInt(name_insured_premium_after_ncd) + parseInt(restore_cover_premium) + parseInt(maternity_new_born_baby_cover_premium) + parseInt(daily_cash_allowance_cover_premium);
        $("#final_combine_cover_with_afterncd_premium_"+add_medi_counter2020).val(final_combine_cover_with_afterncd_premium);
        final_combine_cover_with_afterncd_premium_Cal(add_medi_counter2020);
    }
