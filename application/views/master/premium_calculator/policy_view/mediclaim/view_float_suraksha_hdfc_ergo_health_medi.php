    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr id="annual_turn_over_tr">
                ...
                <td colspn=""><strong>
                <div class="row">
                    <div class="col-md-5 col-form-label" id=""><center><strong id="hdfc_ergo_health_insu_child_count"></strong></center></div>
                    <div class="col-md-2 col-form-label" id=""><center><strong id="hdfc_ergo_health_insu_child_count" >*</strong></center></div>
                    <div class="col-md-5 col-form-label" id=""><center><strong id="hdfc_ergo_health_insu_child_count_first_premium"></strong></center></div>
                </div></strong></td>
                <td><center><strong id="hdfc_ergo_health_insu_child_total_premium"></strong></
                </td>
            </tr>
            <tr id="">
