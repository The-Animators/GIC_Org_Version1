    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="care_float_id" name="care_float_id" class="form-control"><input type="hidden" name="max_age" id="max_age" valuee="" ></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    function family_Size_Val(family_size_new) {
        ...
        if(family_size_new != "" && family_size_new !="null" && family_size_new !=undefined)
            ...
            var family_size = $("#care_health_insu_care_advantage_float_family_size").val();
        ...
        if (family_size == "1A + 1C")
            ...
            AddCare(Family_size_count);
    }

    function AddCare(Family_size_count) {
        var policy_holder_name = $("#policy_holder_name").val();
        // main_Care.push(add_care_counter);
        var tr_table = "";
        $("#first_table_tbody").empty();
        for (var add_care_counter = 0; add_care_counter < Family_size_count; add_care_counter++) {
    ...
    function get_basic_premium() {
        ...
        if (max_age != "" && name_insured_sum_insured != "null"  && name_insured_sum_insured != "" && condition_value != "" && column_value !="") {
            var url = "<?php echo base_url(); ?>master/remote/get_care_health_care_float_basic_prem";
