    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="the_new_india_supertopup_assu_ind_single_policy_id" name="the_new_india_supertopup_assu_ind_single_policy_id" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
        ...
        if (name_insured_member_name != "null" && name_insured_member_name != "" && name_insured_dob !="") {
            $.ajax({
                ...
                success: function(data) {
                    ...
                    if(age > 65){
                        toaster(message_type = "Error", message_txt = "The Age Greater than 65 Years or 65+ Peoples is Not Found Basic Premium in Chart.", message_icone = "error");
                        return false;
                    }
                    get_basic_premium(add_newindia_supertop_counter);
                },
    ...
    function Total_supertopup_the_new_assu_ind() {
    ...
    function get_basic_premium(add_newindia_supertop_counter) {
        ...
        if (name_insured_age != "" && name_insured_sum_insured != "null"  && name_insured_sum_insured != "" && condition_value != "" && column_value !="") {
            var url = "<?php echo base_url(); ?>master/remote/get_the_new_india_assu_policy_super_topup_ind_single_basic_prem";
