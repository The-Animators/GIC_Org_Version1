...
<script>
    ...
    function family_Size_Val(family_size_new) {
        ...
        if(family_size_new != "" && family_size_new !="null" && family_size_new !=undefined)
            ...
            var family_size = $("#suraksha_float_hdfc_ergo_health_insu_family_size").val();
    ...
    function family_Size_coulumn(suraksha_float_hdfc_ergo_health_insu_family_size) {
        var column_value = "";
        if (suraksha_float_hdfc_ergo_health_insu_family_size == "1A + 1C")
           column_value = "1a_1c";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "1A + 2C")
           column_value = "1a_2c";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "1A + 3C")
           column_value = "1a_3c";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "2A + 0C")
           column_value = "2a";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "2A + 1C")
           column_value = "2a_1c";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "2A + 2C")
           column_value = "2a_2c";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "2A + 2P")
           column_value = "2a_2p";
        else if (suraksha_float_hdfc_ergo_health_insu_family_size == "2A + 2P + 2C")
    ...
    function get_basic_premium() {
        ...
        var column_value = family_Size_coulumn(suraksha_float_hdfc_ergo_health_insu_family_size);

        // alert(type_of_policy);suraksha_float_hdfc_ergo_health_insu_family_size
        // alert(condition_value);
        // alert(suraksha_float_hdfc_ergo_health_insu_family_size);
        // alert(column_value);
        if (region != "" && region != "null" && type_of_policy != "" && type_of_policy != "null" && max_age != "" && name_insured_sum_insured != "" && name_insured_sum_insured != "null" && condition_value != "" && suraksha_float_hdfc_ergo_health_insu_family_size != "" && suraksha_float_hdfc_ergo_health_insu_family_size != "null" && column_value !="") {
