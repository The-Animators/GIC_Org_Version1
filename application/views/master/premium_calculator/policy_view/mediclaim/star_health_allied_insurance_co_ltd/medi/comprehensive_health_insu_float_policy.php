...
<script>
    ...
    function family_Size_Val(family_size_new) {
        ...
        if(family_size_new != "" && family_size_new !="null" && family_size_new !=undefined)
            ...
            var family_size = $("#star_health_allied_insu_comprehensive_float_family_size").val();
    ...
    function Total_Medi_starHealth_comprehensive_float() {
    ...
    function getcolumnOnage_1year(age) {
        var column_value = "";
        if (age <= 35) {
            column_value = "3m_35";
        } else if (age <= 45) {
    ...
    function getcolumnOnage_2year(age) {
        var column_value = "";
        if (age <= 34) {
            column_value = "3m_34";
        } else if (age == 35) {
    ...
    function getcolumnOnage_3year(age) {
        var column_value = "";
        if (age <= 33) {
            column_value = "3m_33";
        } else if (age == 34) {
    ...
    function get_basic_premium(add_medi_starHealth_counter) {
        ...
        if(years_of_premium == "1")
            var condition_value = getcolumnOnage_1year(max_age);
        else if(years_of_premium == "2")
            var condition_value = getcolumnOnage_2year(max_age);
        else if(years_of_premium == "3")
            var condition_value = getcolumnOnage_3year(max_age);
        ...
        if (family_size != "null" && family_size != "" && years_of_premium != "null" && years_of_premium != "" && max_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && column_value != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_star_health_allied_comprehensive_float_basic_prem";
