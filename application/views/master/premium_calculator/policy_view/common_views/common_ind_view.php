...
<div class="row">
    <div class="col-md-12" style="overflow-x:auto;">
        <table class="table mb-0 table-bordered" id="first_table">
            <thead>
                <tr>
                    <th><button class="btn btn-primary btn-sm Add_Common_Ind" id="Add_Common_Ind" onclick="AddCommonInd(0)">Add</button></th>
            ...
            <tbody id="first_table_tbody">
                <!-- <tr>
                    <td><button class="btn btn-primary btn-sm dripicons-cross" id="remove_common_ind_0" onClick=remove_Common_Ind(0) disabled></td>
                    ...
                    <td id="policy_option_div"><select style="width:100px;" class="form-control policy_option" name="policy_option[]" id="policy_option_0" disabled>
                            <option value="Floater"  >Floater</option>
                            <option value="Individual" selected>Individual</option>    
                    </select></td>

                    <td width="12%" id="nominee_name_div"><select style="width:280px;" id="nominee_name_0" name="nominee_name[]" class="form-control nominee_name">
                            <option value="null">Select Nominee Name</option>
                        </select></td>
                    <td id="nominee_relation_div"><select style="width:120px;" id="nominee_relation_0" name="nominee_relation[]" class="form-control nominee_relation">
                    ...
                    <td width="8%" id="name_insured_sum_insured_div"><input style="width:110px;" type="text" name="name_insured_sum_insured[]" id="name_insured_sum_insured_0" value="" class="form-control name_insured_sum_insured"></td>

                    <td width="8%" id="name_insured_premium_div"><input style="width:110px;" type="text" name="name_insured_premium[]" id="name_insured_premium_0" value="" class="form-control name_insured_premium" onkeyup="Total_Premium_Cal(0)"></td>
    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            <tr id="declaration_sale_fig_tr">
                ...
                <td><strong id="comm_ind_total_amount_td"><input type="text" id="comm_ind_total_amount" name="comm_ind_total_amount" class="form-control" disabled></strong></td>
            </tr>
            <tr id="annual_turn_over_tr">
                <td colspn=""><strong> Less Discount: </strong></td>

                <td colspn=""><strong><input type="text" id="comm_ind_less_discount_rate" name="comm_ind_less_discount_rate" class="form-control" onkeyup="comm_ind_less_discount_tot_Cal()"></strong></td>
                <td><strong id="comm_ind_less_discount_tot_td"><input type="text" id="comm_ind_less_discount_tot" name="comm_ind_less_discount_tot" class="form-control" onkeyup="comm_ind_load_tot_Cal()" ></strong></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong>Add Loading: </strong></td>
                <td colspn=""><strong><textarea id="comm_ind_load_desc" name="comm_ind_load_desc" class="form-control" rows="3"></textarea></strong></td>
                <td><strong id="comm_ind_load_tot_td"><input type="text" id="comm_ind_load_tot" name="comm_ind_load_tot" class="form-control" onkeyup="comm_ind_load_tot_Cal()" ></strong></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong>Premium After Loading/Gross Premium: </strong></td>
                <td colspn=""><strong></strong></td>
                <td><strong id="comm_ind_gross_premium_td"><input type="text" id="comm_ind_gross_premium" name="comm_ind_gross_premium" class="form-control" disabled><input type="hidden" id="comm_ind_gross_premium_new" name="comm_ind_gross_premium_new" class="form-control" disabled></strong></td>
            </tr>
            <tr>
                <td colspn=""><strong> CGST:</strong></td>
                <td><strong id="comm_ind_cgst_rate_td"><input type="text" id="cgst_fire_per" name="comm_ind_cgst_rate" class="form-control" onkeyup="gst_apply()"></td>
                <td><strong id="comm_ind_cgst_tot_td"><input type="text" id="comm_ind_cgst_tot" name="comm_ind_cgst_tot" class="form-control" disabled></td>
            </tr>
            <tr>
                <td><strong> SGST</strong></td>
                <td><strong id="comm_ind_sgst_rate_td"><input type="text" id="sgst_fire_per" name="comm_ind_sgst_rate" class="form-control" onkeyup="gst_apply()"></td>
                <td><strong id="comm_ind_sgst_tot_td"><input type="text" id="comm_ind_sgst_tot" name="comm_ind_sgst_tot" class="form-control" disabled></td>
            </tr>
            <tr>
                <td colspn="3"><strong class="text-purple">Final Premium</strong></td>
                <td colspn="2"><strong></strong></td>
                <td><strong id="comm_ind_final_premium_td"><input type="text" id="comm_ind_final_premium" name="comm_ind_final_premium" class="form-control" disabled><input type="hidden" id="common_ind_policy_id" name="common_ind_policy_id" class="form-control" ></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    var add_commonind_counter = 0;
    var main_CommonInd = [];
    function remove_Common_Ind(add_commonind_counter) {
        $("#remove_common_ind_" + add_commonind_counter).closest("tr").remove();
        var indexValue = main_CommonInd.indexOf(add_commonind_counter);
        main_CommonInd.splice(indexValue, 1);

        if (main_CommonInd.length == 0) {
            add_commonind_counter = 0;
            main_CommonInd = [];
            $("#Add_Common_Ind").attr("onClick", "AddCommonInd(" + add_commonind_counter + ")");
        }
        // main_CommonInd.splice(main_CommonInd.indexOf(add_commonind_counter), 1);
        // var indexValue = main_CommonInd.indexOf(add_commonind_counter);
        //     main_CommonInd.splice(indexValue, 1);
    ...
    var actual_data_CommonInd = [];

    function Total_CommonInd() {
        actual_data_CommonInd = [];
        ...
        $("#first_table tr:has(.name_insured_member_name)").each(function(key, val) {
            ...
            actual_data_CommonInd.push([key, name_insured_member_name , name_insured_member_name_txt , name_insured_dob , name_insured_age , name_insured_relation , name_insured_relation_txt , past_history , type_of_policy , policy_option , nominee_name , nominee_name_txt , nominee_relation , nominee_relation_txt , name_insured_sum_insured , name_insured_premium]);
            
            if (name_insured_member_name == '')
                actual_data_CommonInd.splice(key, 1);
        });
        // console.log(actual_data_CommonInd);
        // alert(actual_data_CommonInd);
        return actual_data_CommonInd;

        // var total_commonind = JSON.stringify(Total_CommonInd());
        // alert(total_commonind);
        // return false;
    }
// Calculation Section Start
    ...
    function get_dob(add_commonind_counter) {
        // alert(add_commonind_counter);
        var rowCount = $('#first_table tbody tr').length;

        if(add_commonind_counter == 0){
            var name_insured_relation =  $('#name_insured_relation_'+add_commonind_counter+' option').filter(function () { return $(this).html() == "Self"; }).val();
            $('#name_insured_relation_'+add_commonind_counter).val(name_insured_relation);
        }
        
        var name_insured_member_name = $("#name_insured_member_name_"+add_commonind_counter).val();
        ...
        if (name_insured_member_name != "") {
            $.ajax({
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        $('#name_insured_dob_'+add_commonind_counter).val("");
                        ...
                        // alert(dob);
                        $('#name_insured_dob_'+add_commonind_counter).val(dob);
    ...
    function get_age(add_commonind_counter) {
        var name_insured_member_name = $("#name_insured_member_name_"+add_commonind_counter).val();
        var name_insured_dob = $("#name_insured_dob_"+add_commonind_counter).val();
        ...
        if (name_insured_member_name != "") {
            $.ajax({
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        $('#name_insured_age_'+add_commonind_counter).val("");
                        var age = data["age"];
                        $('#name_insured_age_'+add_commonind_counter).val(age);
                    } else {
                        $('#name_insured_age_'+add_commonind_counter).val("");
                    }
                },
    ...
    function Total_Premium_Cal(add_commonind_counter){
        ...
        for (var i = 0; i < inputs.length; i++) {
            ...
            $("#comm_ind_total_amount").val(total);
            $("#comm_ind_gross_premium").val(total);
        }
        gst_apply();
        comm_ind_less_discount_tot_Cal();
        comm_ind_load_tot_Cal();
    }

    function comm_ind_less_discount_tot_Cal() {

        var comm_ind_less_discount_rate = $("#comm_ind_less_discount_rate").val();
        var comm_ind_total_amount = $("#comm_ind_total_amount").val();

        comm_ind_less_discount_rate = parseInt(comm_ind_less_discount_rate);
        comm_ind_total_amount = parseInt(comm_ind_total_amount);

        if (isNaN(comm_ind_less_discount_rate))
            comm_ind_less_discount_rate = 0;
        else
            comm_ind_less_discount_rate = comm_ind_less_discount_rate;

        if (isNaN(comm_ind_total_amount))
            comm_ind_total_amount = 0;
        else
            comm_ind_total_amount = comm_ind_total_amount;

        if(comm_ind_less_discount_rate !="" || comm_ind_less_discount_rate !=0){

        var comm_ind_less_discount_tot = Math.round((comm_ind_less_discount_rate * comm_ind_total_amount) / 100);
        comm_ind_less_discount_tot = parseInt(comm_ind_less_discount_tot);
        
        if (isNaN(comm_ind_less_discount_tot))
            comm_ind_less_discount_tot = 0;
        else
            comm_ind_less_discount_tot = comm_ind_less_discount_tot;

        var comm_ind_gross_premium=parseInt(comm_ind_total_amount)-parseInt(comm_ind_less_discount_tot);
        // alert(comm_ind_gross_premium);
        $("#comm_ind_less_discount_tot").val(comm_ind_less_discount_tot);
        }
        $("#comm_ind_gross_premium_new").val(comm_ind_gross_premium);
        comm_ind_load_tot_Cal();
        gst_apply();
    }

    function comm_ind_load_tot_Cal(){
        var comm_ind_less_discount_rate = $("#comm_ind_less_discount_rate").val();
        ...
        comm_ind_less_discount_rate = parseInt(comm_ind_less_discount_rate);
        comm_ind_gross_premium_new = parseInt(comm_ind_gross_premium_new);
        comm_ind_less_discount_tot = parseInt(comm_ind_less_discount_tot);
        comm_ind_load_tot = parseInt(comm_ind_load_tot);
        ...
        if (isNaN(comm_ind_gross_premium_new))
            comm_ind_gross_premium_new = 0;
        else
        ...
        if (isNaN(comm_ind_load_tot))
            ...
            if(comm_ind_less_discount_rate =="" || comm_ind_less_discount_rate ==0){
                ...
                if (isNaN(comm_ind_total_amount))
                    ...
                    comm_ind_gross_premium_new = comm_ind_total_amount;
            }
            // alert(comm_ind_less_discount_rate+"rate");
            if(comm_ind_less_discount_rate !="" || comm_ind_less_discount_rate !=0)
                var new_comm_ind_gross_premium = comm_ind_gross_premium_new+comm_ind_load_tot;
            else
                var new_comm_ind_gross_premium = (comm_ind_gross_premium_new-comm_ind_less_discount_tot)+comm_ind_load_tot;
            // alert(comm_ind_gross_premium_new+"new");
            // alert(new_comm_ind_gross_premium+"Gross");
        $("#comm_ind_gross_premium").val(new_comm_ind_gross_premium);
        gst_apply();
    }
    ...
    function gst_apply() {
        ...
        comm_ind_gross_premium = parseInt(comm_ind_gross_premium);
        if (isNaN(comm_ind_gross_premium))
            comm_ind_gross_premium = 0;
        else
            comm_ind_gross_premium = comm_ind_gross_premium;

        if (comm_ind_gross_premium == "") {
            $("#comm_ind_cgst_tot").val(0);
            $("#comm_ind_sgst_tot").val(0);
            $("#comm_ind_final_premium").val(0);
        }

        var comm_ind_cgst_tot = Math.round((comm_ind_gross_premium * cgst_fire_per) / 100);
        var comm_ind_sgst_tot = Math.round((comm_ind_gross_premium * sgst_fire_per) / 100);
        $("#comm_ind_cgst_tot").val(comm_ind_cgst_tot);
        $("#comm_ind_sgst_tot").val(comm_ind_sgst_tot);

        var comm_ind_final_premium = parseInt(comm_ind_gross_premium) + parseInt(comm_ind_cgst_tot) + parseInt(comm_ind_sgst_tot);
