...
<script>
    ...
    function Total_PAccident() {
        ...
        $("#first_table tr:has(.name_insured_member_name)").each(function(key, val) {
            ...
            var risk_group_2 = $(".risk_group_2", this).val();
            var risk_group_3 = $(".risk_group_3", this).val();
            var risk_group_4 = $(".risk_group_4", this).val();
            ...
            actual_data_PAccident.push([key, name_insured_member_name , name_insured_member_name_txt , name_insured_dob , name_insured_age , name_insured_relation , name_insured_relation_txt , nominee_name , nominee_name_txt , nominee_relation , nominee_relation_txt , name_insured_sum_insured_1 , name_insured_sum_insured_2 , name_insured_sum_insured_3 , name_insured_sum_insured_4 , sum_insured , risk_group_1 , risk_group_2 , risk_group_3 , risk_group_4 , name_insured_premium_1 , name_insured_premium_2 , name_insured_premium_3 , name_insured_premium_4 , premium]);
    ...
    function get_premium(add_pa_counter,count){
        ...
        var risk_group = $("#risk_group_"+add_pa_counter+"_"+count).val();

        var risk_group_rate = "";
        if(count==1){
            if((risk_group != "null") && (risk_group != "")){
                if(risk_group == "Risk Group 1")
                    risk_group_rate = 0.45;
                else if(risk_group == "Risk Group 2")
                    risk_group_rate = 0.60;
                else if(risk_group == "Risk Group 3")
                    risk_group_rate = 0.90;
            }
        }else if(count==2){
            if((risk_group != "null") && (risk_group != "")){
                if(risk_group == "Risk Group 1")
                    risk_group_rate = 0.65;
                else if(risk_group == "Risk Group 2")
                    risk_group_rate = 0.90;
                else if(risk_group == "Risk Group 3")
                    risk_group_rate = 1.30;
            }
        }else if(count==3){
            if((risk_group != "null") && (risk_group != "")){
                if(risk_group == "Risk Group 1")
                    risk_group_rate = 0.95;
                else if(risk_group == "Risk Group 2")
                    risk_group_rate = 1.25;
                else if(risk_group == "Risk Group 3")
                    risk_group_rate = 1.75;
            }
        }else if(count==4){
            if((risk_group != "null") && (risk_group != "")){
                if(risk_group == "Risk Group 1")
                    risk_group_rate = 1.50;
                else if(risk_group == "Risk Group 2")
                    risk_group_rate = 2.00;
                else if(risk_group == "Risk Group 3")
                    risk_group_rate = 3.00;
            }
        }
        var name_insured_premium = 0;
        name_insured_premium = Math.round((name_insured_sum_insured * risk_group_rate)/1000);
    ...
    function premium_Cal(add_pa_counter){
        ...
        var name_insured_premium_2 = $("#name_insured_premium_"+add_pa_counter+"_2").val();
        var name_insured_premium_3 = $("#name_insured_premium_"+add_pa_counter+"_3").val();
        var name_insured_premium_4 = $("#name_insured_premium_"+add_pa_counter+"_4").val(); 

        name_insured_premium_1 = parseInt(name_insured_premium_1);
        name_insured_premium_2 = parseInt(name_insured_premium_2);
        name_insured_premium_3 = parseInt(name_insured_premium_3);
        name_insured_premium_4 = parseInt(name_insured_premium_4);
        ...
        if (isNaN(name_insured_premium_2))
            name_insured_premium_2 = 0;
        else
            name_insured_premium_2 = name_insured_premium_2;

        if (isNaN(name_insured_premium_3))
            name_insured_premium_3 = 0;
        else
            name_insured_premium_3 = name_insured_premium_3;

        if (isNaN(name_insured_premium_4))
            name_insured_premium_4 = 0;
        else
            name_insured_premium_4 = name_insured_premium_4;

        premium = name_insured_premium_1 + name_insured_premium_2 + name_insured_premium_3 + name_insured_premium_4;
