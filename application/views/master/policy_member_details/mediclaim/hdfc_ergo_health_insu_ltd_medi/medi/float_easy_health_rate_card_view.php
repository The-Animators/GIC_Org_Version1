...
<div class="row">
    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr id="">
                <td colspn="3"><strong> Stay Active Benefit: </strong></td>
                <td colspn=""><strong><input type="text" id="stay_active_benefit" name="stay_active_benefit" class="form-control stay_active_benefit"  onkeyup="Tot_stay_active_benefit_premium()" value="0"></strong></td>
                <td><strong id="stay_active_benefit_prem_td"><input type="text" id="stay_active_benefit_prem" name="stay_active_benefit_prem" class="form-control stay_active_benefit_prem" disabled></td>
            </tr>
            <tr id="">
                <td colspn="3"><strong> Long Term Premuim Discount : </strong></td>
                <td colspn="">
                    <div class="row">
                        <div class="col-md-6"><input type="text" id="less_disc_per" name="less_disc_per" class="form-control less_disc_per" onkeyup="medi_less_disc_tot_Cal()" value="0"></strong></div>
                        <div class="col-md-6"><input type="text" id="tot_basic_prem" name="tot_basic_prem" class="form-control" disabled></div>
                    </div>
                </td>
...
<script>
    ...
    function family_Size_Val(family_size_new) {
        ...
        else if (sub_policy_family_size == "1A + 5C")
    ...
    function get_sum_insured_dropdown(){
        ...
        // type_of_policy = sum_insured_int_Converter(type_of_policy);
        ...
        if(type_of_policy != "null" || type_of_policy !=""){
            var standard_paln_sum_Val = ["2,00,000", "3,00,000", "4,00,000", "5,00,000","7,50,000", "10,00,000", "15,00,000"];
            var exclusive_premium_plan_sum_Val = ["3,00,000", "4,00,000", "5,00,000","7,50,000", "10,00,000", "15,00,000", "20,00,000", "25,00,000", "50,00,000"];

            if(type_of_policy == "Standard Plan"){
                $("#name_insured_sum_insured").empty();
                type_of_policy_sum_insured = standard_paln_sum_Val;
                loop_count = 6;
                var i = 0;
            ...
            }else if(type_of_policy == "Exclusive Plan" || type_of_policy == "Premium Plan"){
                $("#name_insured_sum_insured").empty();
                type_of_policy_sum_insured = exclusive_premium_plan_sum_Val;
                loop_count = 8;
                var i = 0;
                for (i; i <= loop_count; i++) {
                    type_of_policy_sum_insured_dropdown_val += '<option value="' + type_of_policy_sum_insured[i] + '">' + type_of_policy_sum_insured[i] + '</option>';
            ...
            // alert(type_of_policy_sum_insured_dropdown_val);
    ...
    function Total_Medi_float_easy_rate_CardHDFC() {
    ...
    function get_hospital_daily_cash(sub_policy_family_size){
        var column_value = "";
        if (sub_policy_family_size == "1A + 1C") {
            column_value = "1a_1c";
        }else if (sub_policy_family_size == "1A + 2C") {
    ...
    function Tot_protector_rider_type_premium(){
        ...
        get_easy_rate_card_option_premium();
        $("#protector_rider_prem").val(protector_rider_prem);
        Tot_protect_ride_prem_tot();
    }

    function get_easy_rate_card_option_premium(){
        ...
        if (max_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && protector_rider_type != "null" && protector_rider_type != "" && condition_value != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_easy_rate_card_option_premium";
            ...
            if (url != "") {
                $.ajax({
                    ...
                    data: {
                        ...
                        protector_rider_type: protector_rider_type,
                    },
                    type: 'POST',
                    dataType: 'json',
                    async: false,
                    ...
                    success: function(data) {
                        if (data["status"] == true) {
                            ...
                            $('#optional_premium').val("");
                            $('#optional_premium').val(data["userdata"]);
    ...
    function get_hospital_daily_cash_prem() {
        ...
        var sub_policy_family_size = $("#sub_policy_family_size").val();
        sub_policy_family_size = get_hospital_daily_cash(sub_policy_family_size);
        
        if (max_age != "" && hospital_daily_cash_per_day != ""  && hospital_daily_cash_per_day != "null" && condition_value != "" && sub_policy_family_size != "null" && sub_policy_family_size != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_hospital_daily_easy_rate_card_cash_prem";
            ...
            if (url != "") {
                $.ajax({
                    ...
                    data: {
                        ...
                        condition_value: condition_value,
                        column_value: sub_policy_family_size,
                    },
                    type: 'POST',
                    dataType: 'json',
                    async: false,
    ...
    function get_basic_premium() {
        ...
        if (region != "null" && region != "" && type_of_policy != "null" && type_of_policy != "" && max_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && sub_policy_family_size != "null" && sub_policy_family_size != "") {
            var url = "<?php echo base_url(); ?>master/remote/get_float_easy_rate_card_hdfc_ergo_health_insu_basic_premium";
                    ...
                    success: function(data) {
                        if (data["status"] == true) {
                            ...
                            if(years_of_premium==1){
                                ...
                                $("#tot_basic_prem").val(data["userdata"]);
                            }
    ...
    function get_premium_Of_Child() {
        ...
        if (max_age != "" && hospital_daily_cash_per_day != "null" && hospital_daily_cash_per_day != "" ) {
            var url = "<?php echo base_url(); ?>master/remote/get_float_easy_rate_card_hdfc_ergo_health_insu_chart_for_child";
            // alert(url);
            if (url != "") {
                $.ajax({
                    url: url,
    ...
    function Tot_stay_active_benefit_premium(){
        ...
        // alert(basic_premium);
        // alert(stay_active_benefit);
        // alert(stay_active_benefit_prem);
    ...
    function Tot_premium_after_discount(){
        var basic_premium = $("#basic_premium").val();
        var optional_premium = $('#optional_premium').val();

        basic_premium = parseInt(basic_premium);
        optional_premium = parseInt(optional_premium);
        ...
        if (isNaN(optional_premium))
            optional_premium = 0;
        else
            optional_premium = optional_premium;

        var premium_after_discount = 0;
        premium_after_discount = (basic_premium + optional_premium);
        ...
        $("#premium_after_discount").val(premium_after_discount);
        $("#tot_premium").val(premium_after_discount);
        // Tot_premium();
    ...
    function Tot_gross_premium(){
        var tot_premium = $("#premium_after_discount").val();
        ...
        var last_gross_premium_tot = gross_premium_tot-discount;
    ...
    function ncd_amount_Cal() {
        var ncd_percentage = $("#ncb_per").val();
    ...
    function medi_less_disc_tot_Cal() {
        ...
        var years_of_premium = $("#years_of_premium").val();
        var tot_premium = $("#tot_basic_prem").val();
