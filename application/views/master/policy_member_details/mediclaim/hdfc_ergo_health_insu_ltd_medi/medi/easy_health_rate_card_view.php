    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            ...
            <tr id="">
                ...
                <td><strong id="load_tot_td"><input type="text" id="load_tot" name="load_tot" class="form-control load_tot" onkeyup="Tot_gross_premium();medi_family_disc_tot_Cal();"></td>
            </tr>
            <tr id="">
                <td colspn="3"><strong> Family Discount in Individual Policy only if 2 or more person covered: </strong></td>
                <td colspn=""><strong><input type="text" id="family_disc_per" name="family_disc_per" class="form-control family_disc_per"  onkeyup="medi_family_disc_tot_Cal()" value="0"></strong></td>
            ...
            <tr>
                ...
                <td><strong id="medi_final_premium_td"><input type="text" id="medi_final_premium" name="medi_final_premium" class="form-control" disabled><input type="hidden" id="medi_hdfc_ergo_health_insu_easy_policy_id" name="medi_hdfc_ergo_health_insu_easy_policy_id" class="form-control"></td>
            </tr>
        </table>
    </div>
</div>
...
<script>
    ...
    function get_sum_insured_dropdown(add_medi_hdfc_counter){
        ...
        if(type_of_policy != "null" || type_of_policy !=""){
            var standard_paln_sum_Val = ["1,00,000", "1,50,000", "2,00,000", "2,50,000", "3,00,000", "4,00,000", "5,00,000","7,50,000", "10,00,000", "15,00,000"];
    ...
    function Total_Medi_easy_rate_CardHDFC() {
    ...
    function Tot_protector_rider_type_premium(add_medi_hdfc_counter){
        ...
        get_easy_rate_card_option_premium(add_medi_hdfc_counter);
    ...
    function get_basic_premium(add_medi_hdfc_counter) {
        ...
        if (region != "null" && region != "" && name_insured_age != "" && name_insured_sum_insured != "null"  && name_insured_sum_insured != "" && condition_value != "" && type_of_policy !="null" && type_of_policy !="") {
            var url = "<?php echo base_url(); ?>master/remote/get_hdfc_ergo_health_insu_easy_rate_card_basic_premium";
                    ...
                    if (url != "") {
                        $.ajax({
                            ...
                            success: function(data) {
                                ...
                                // get_easy_rate_card_option_premium(val);
    ...
    function get_easy_rate_card_option_premium(add_medi_hdfc_counter){
        ...
        if(name_insured_sum_insured > 1000000){
        ...
        if (name_insured_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && protector_rider_type != "null" && protector_rider_type != "" && condition_value != "") {
            ...
            if (url != "") {
                $.ajax({
                    ...
                    success: function(data) {
                        if (data["status"] == true) {
                            if(data["userdata"]=="")
                                $('#optional_premium_' + add_medi_hdfc_counter).val("");

                            $('#optional_premium_' + add_medi_hdfc_counter).val("");
                            $('#optional_premium_' + add_medi_hdfc_counter).val(data["userdata"]);
    ...
    function Tot_premium_after_discount(add_medi_hdfc_counter){
        ...
        var optional_premium = $('#optional_premium_' + add_medi_hdfc_counter).val();
        basic_premium = parseInt(basic_premium);
        ...
        premium_after_discount = (basic_premium + optional_premium - stay_active_benefit_prem);
    ...
    function medi_less_disc_tot_Cal() {
        ...
        tot_basic_prem = parseInt(tot_basic_prem);
        ...
        if (isNaN(tot_basic_prem))
            tot_basic_prem = 0;
        else
            tot_basic_prem = tot_basic_prem;

        var less_disc_tot = Math.round((less_disc_per * tot_basic_prem) / 100);
        less_disc_tot = parseInt(less_disc_tot);
        // alert(less_disc_tot);
    ...
    function medi_family_disc_tot_Cal() {
        ...
        if (rowCount == 1) {
            ...
            var newVals = $("#family_disc_per").val();
                    if(newVals!=""){
                        if (vals == 0 || vals == "#" || vals !="") {
                            $("#family_disc_per").val(5);
                        }
                    } 
            // if (vals == 0 && vals != "#") {
                // alert(vals);
        ...
        // alert(tot_premium);
        // alert(family_disc_per);
        // alert(family_disc_tot);
