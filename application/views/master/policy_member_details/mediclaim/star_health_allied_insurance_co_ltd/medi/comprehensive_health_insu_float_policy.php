...
<script>
    ...
    function get_basic_premium(add_medi_starHealth_counter) {
        ...
        if (sub_policy_family_size!= "null" && sub_policy_family_size!= "" && years_of_premium != "null" && years_of_premium != "" && max_age != "" && name_insured_sum_insured != "null" && name_insured_sum_insured != "" && condition_value != "" && column_value != "") {
