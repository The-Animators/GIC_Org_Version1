...
<div class="row">
    <div class="col-md-12" style="overflow-x:auto;">
        <table class="table mb-0 table-bordered" id="first_table">
            ...
            <!-- <tr>
                <td><button class="btn btn-primary btn-sm dripicons-cross" id="remove_mediclaim_0" onClick=removeMediclaim(0) disabled></td>
                    ...
                    <td><select style="width:120px;" id="name_insured_policy_type_0" name="name_insured_policy_type[]" class="form-control name_insured_policy_type" onchange="remove_sumInsured_basedon_policyType(0)">
                    ...
                    <td width="12%"><select style="width:105px;" id="name_insured_sum_insured_0" name="name_insured_sum_insured[]" class="form-control name_insured_sum_insured" onchange="premium_basedon_Type(0)">
                    ...
                    <td width="8%">
                        <div class="row">
                            <div class="col-md-12"><select style="width:90px;" id="dm_yes_no_0" name="dm_yes_no[]" class="form-control dm_yes_no" onchange="dm_yes_no(0)">
                                    <option value="No">No</option>
                                    <option value="Yes">Yes</option>
                                    
                                </select></div>
                            <div class="col-md-12 mt-1"><input style="width:90px;" type="text" name="dm_percentage[]" id="dm_percentage_0" value="10" class="form-control dm_percentage" onkeyup="dm_loading_Cal(0)"></div>
                        </div>
                    </td>
                    <td width="8%"><input style="width:110px;" type="text" name="dm_loading[]" id="dm_loading_0" value="" class="form-control dm_loading"></td>
                    <td width="8%">
                        <div class="row">
                            <div class="col-md-12"><select style="width:90px;" id="htn_yes_no_0" name="htn_yes_no[]" class="form-control htn_yes_no" onchange="htn_yes_no(0)">
                                    <option value="No">No</option>
                                    <option value="Yes">Yes</option>     
                                </select></div>
                            <div class="col-md-12 mt-1"><input style="width:90px;" type="text" name="htn_percentage[]" id="htn_percentage_0" value="10" class="form-control htn_percentage" onkeyup="htn_loading_Cal(0)"></div>
                        </div>
                    </td>
                    <td><input style="width:110px;" type="text" name="htn_loading[]" id="htn_loading_0" value="" class="form-control htn_loading"></td>
                    <td><input style="width:110px;" type="text" name="premium_after_loading[]" id="premium_after_loading_0" value="" class="form-control premium_after_loading"></td>
                    <td width="9%">
                        <select style="width:90px;" id="ncd_percentage_0" name="ncd_percentage[]" class="form-control ncd_percentage" onchange="ncd_amount_Cal(0)">
                    ...
                    <td><input style="width:110px;" type="text" name="ncd_amount[]" id="ncd_amount_0" value="" class="form-control ncd_amount"></td>
                    <td><input style="width:110px;" type="text" name="premium_after_ncd_amount[]" id="premium_after_ncd_amount_0" value="" class="form-control premium_after_ncd_amount"></td>
            </tr> -->
...
<script>
    ...
    var actual_data_Mediclaim = [];

    function Total_Mediclaim() {
        actual_data_Mediclaim = [];
