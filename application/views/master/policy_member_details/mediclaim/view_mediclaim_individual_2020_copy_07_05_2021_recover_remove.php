    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            <tr id="declaration_sale_fig_tr">
                ...
                <td><strong id="medi_ind_2020_total_premium"></strong></td>
            </tr>
            <tr id="annual_turn_over_tr">
                ...
                <td colspn=""><strong id="medi_ind_2020_family_descount_per"></strong></td>
                <td><strong id="medi_ind_2020_family_descount_tot"></strong></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong> Add Loading: </strong></td>
                <td colspn=""><strong id="medi_ind_2020_load_description"></strong></td>
                <td><strong id="medi_ind_2020_load_amount"></strong></td>
            </tr>
            ...
            <tr id="tot_sum_insured_tr">
                ...
                <td colspn=""><strong id=""></strong></td>
                <td><strong id="medi_ind_2020_load_gross_premium"></strong></td>
            </tr>
            <tr>
                <td colspn=""><strong> CGST:</strong></td>
                <td><strong id="cgst_fire_per"></strong></td>
                <td><strong id="medi_ind_2020_cgst_tot"></strong></td>
            </tr>
            <tr>
                <td><strong> SGST</strong></td>
                <td><strong id="sgst_fire_per"></strong></td>
                <td><strong id="medi_ind_2020_sgst_tot"></strong></td>
            </tr>
            <tr>
                <td colspn="3"><strong class="text-purple">Final Premium</strong></td>
                <td colspn="3"><strong class="text-purple"></strong></td>
                <td><strong id="medi_ind_2020_final_premium" class="text-purple"></strong></td>
            </tr>
        </table>
    </div>
</div>
