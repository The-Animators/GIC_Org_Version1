    ...
    <div class="col-md-12">
        <table class="table mb-0 table-bordered mt-2 col-md-12">
            <tr id="declaration_sale_fig_tr">
                <td colspn="2" width="75%"><strong> Total Premium: </strong></td>
                <td colspn="2" width="17%"><strong></strong></td>
                <td><center><strong id="supertopup_ind_total_premium"></strong></center></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong> Add Loading: </strong></td>
                <td colspn=""><center><strong id="supertopup_ind_description"></strong></center></td>
                <td><center><strong id="supertopup_ind_load_amount"></strong></center></td>
            </tr>
            <tr id="tot_sum_insured_tr">
                <td colspn="3"><strong> Premium After Loading/Gross Premium: </strong></td>
                <td colspn=""><strong id=""></strong></td>
                <td><center><strong id="supertopup_ind_load_gross_premium"></strong></center></td>
            </tr>
            <tr>
                <td colspn=""><strong> CGST:</strong></td>
                <td><center><strong id="cgst_fire_per"></strong></center></td>
                <td><center><strong id="supertopup_ind_cgst_tot"></strong></center></td>
            </tr>
            <tr>
                <td><strong> SGST</strong></td>
                <td><center><strong id="sgst_fire_per"></strong></center></td>
                <td><center><strong id="supertopup_ind_sgst_tot"></strong></center></td>
            </tr>
            <tr>
                <td colspn="3"><strong class="text-purple">Final Premium</strong></td>
                <td colspn="3"><strong class="text-purple"></strong></td>
                <td><center><strong id="supertopup_ind_final_premium" class="text-purple"></strong></center></td>
            </tr>
        </table>
    </div>
