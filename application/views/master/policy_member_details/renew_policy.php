                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-row">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-4">
                                                <select class="form-control" id="serial_no_month" name="serial_no_month" onchange="getPolicyCounter()">
                                                    ...
                                                    <?php $month = date('m');  //print_r($month);
                                                    //die(); ?>
                                    ...
                                    <div class="col-md-4" id="individual_policy_type_div" style="display:none;">
                                        <div class="form-group row">
                                            <label for="individual_policy_type" class="col-form-label col-md-4  text-right">Individual Policy Type<span class="text-danger">*</span></label>
                                            <div class="col-md-8">
...
<script>
    ...
    function policyNameBased_Policy_option(policy_name_txt_val) {
    ...
    function Policy_typeName() {
        ...
        if (policy_name_txt != "Mediclaim" && policy_type_txt == "Individual")
            $("#3_cover_div").hide();
        if (policy_name_txt == "Super Top Up" && policy_type_txt == "Floater") {
        ...
        // alert(policy_name_txt);
        if (policy_name_txt == "Term Plan" || policy_name_txt == "Mediclaim" || policy_name_txt == "Super Top Up" || policy_name_txt == "GMC" || policy_name_txt == "GPA" || policy_name_txt == "Personal Accident") {
            $("#risk_individual").hide();
            $("#risk_floater").hide();
            $("#risk_floater_add").hide();
            $("#risk_rc").hide();
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        ...
                        if ((data["userdata"].policy_type_title == "Mediclaim" || data["userdata"].policy_type_title == "Super Top Up" || data["userdata"].policy_type_title == "Personal Accident" || data["userdata"].policy_type_title == "GMC" || data["userdata"].policy_type_title == "GPA")) {
                            policyNameBased_Policy_option(data["userdata"].policy_type_title);
                        }
                        ...
                        if ((data["userdata"].policy_type_title == "Mediclaim" || data["userdata"].policy_type_title == "Super Top Up" || data["userdata"].policy_type_title == "Personal Accident" || data["userdata"].policy_type_title == "GMC" || data["userdata"].policy_type_title == "GPA") && (data["userdata"].policy_type == 4 || data["userdata"].policy_type == 5)) {
                        ...
                        if (data["userdata"].policy_type == 2 && data["userdata"].policy_type_title == "Super Top Up") {
                            if (data["userdata"].policy_type != 3) {
                                // alert("hi")
                                family_Size_Val(data["userdata"].family_size);
                                $("#family_size").val(data["userdata"].family_size);
                        ...
                        if (data["userdata"].policy_type == 1 && data["userdata"].policy_type_title == "Super Top Up") {
                            if (data["userdata"].policy_type != 3) {
    ...
    function edit_Common_Individual(common_ind_data_arr) {
        ...
        $("#Add_Common_Ind").attr("onClick", "AddCommonInd(" + (parseInt(commonind_length) - 1) + ")");
    ...
    function edit_supertopup_Individual_policy(supertopup_ind_data_arr) {
        ...
        $("#Add_SuperTop_ind").attr("onClick", "Add_SuperTop_Individual(" + (parseInt(supertopup_length) - 1) + ")");
    ...
    //         function current_age(add_medi_counter){
            //     get_dob(add_medi_counter);
            // }
            // current_age(add_medi_counter);
        });
    ...
    function edit_medi_ind2020_policy(medi_ind2020_policy_data_arr) {
        ...
        $("#Add_Mediclaim_2020").attr("onClick", "AddMediclaim2020(" + (mediclaim_length - 1) + ")");
        $("#first_table_tbody").append(mediclaim_tr);
    ...
    function edit_mediclaim_policy(mediclaim_policy_data_arr) {
        ...
        $("#Add_Mediclaim").attr("onClick", "AddMediclaim(" + (mediclaim_length - 1) + ")");
        $("#first_table_tbody").append(mediclaim_tr);
    ...
    $("#update").click(function() {
        ...
        if (policy_name_txt == "Super Top Up" && policy_type_txt == "Individual") {
            var tpa_company = $("#tpa_company").val();
            form_data.append('tpa_company', tpa_company);
        ...
        if (policy_name_txt == "GMC" && (policy_type_txt == "Individual" || policy_type_txt == "Floater")) {
            // alert("Hi");
        ...
        if (policy_name_txt == "GPA" && (policy_type_txt == "Individual" || policy_type_txt == "Floater")) {
        ...
        if ((policy_name_txt == "Mediclaim" || policy_name_txt == "Super Top Up" || policy_name_txt == "Personal Accident" || policy_name_txt == "GMC" || policy_name_txt == "GPA") && (policy_type_txt == "Common Individual" || policy_type_txt == "Common Floater")) {
            var tpa_company = $("#tpa_company").val();
            form_data.append('tpa_company', tpa_company);
