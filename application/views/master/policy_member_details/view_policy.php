                ...
                success: function(data) {
                    ...
                    if (data["status"] == true) {
                        ...
                        $.each(employee, function(key, val) {
                            ...
                            if (remarks == "" || remarks == null || remarks == "null" || remarks == undefined || remarks == "undefined")
                                remarks = '';
                            else
                                remarks = remarks;
            ...
            $.ajax({
                ...
                success: function(data) {
                    if (data["status"] == true) {
                        ...
                        if (data["userdata"].policy_upload == "" || data["userdata"].policy_upload == null || data["userdata"].policy_upload == "null" || data["userdata"].policy_upload == "undefined" || data["userdata"].policy_upload == undefined) {
                        ...
                        if (data["userdata"].quotation_upload == "" || data["userdata"].quotation_upload == null || data["userdata"].quotation_upload == "null" || data["userdata"].quotation_upload == "undefined" || data["userdata"].quotation_upload == undefined) {
