                    ...
                    <div class="card-box table-responsive">
                        <div class="row">
                            ...
                            <div class="col-md-4 text-right">
                                <a href="<?php echo base_url() . "master/staff"; ?>" class='btn btn-secondary waves-effect btn-xs'>Back</a>
                            </div>
                                        ...
                                        <table id="datatable" class="table  table-striped table-bordered  dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tbody id="tableData">
                                                ...
                                                if (!empty($role_permission)) :
                                                    foreach ($role_permission as $row1) :
                                                        $add = $row1[0];
                                                        $edit = $row1[1];
                                                        $view = $row1[2];
                                                        $delete_txt = $row1[3];
                                                                    ...
                                                                    <tr>
                                                                        ...
                                                                        <td>
                                                                            ...
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="add[]" class="custom-control-input add" id="add_<?php echo $row["submenu_id"]; ?>" onclick="check_checkbox(<?php echo $row['submenu_id']; ?>)" <?php if ($submenu_id == $row['submenu_id']) {
                                                                                                                                                                                                                                                                if ($add == 1) : echo "checked";
                                                                                                                                                                                                                                                                endif;
                                                                                                                                                                                                                                                            } ?>>
                                                                        ...
                                                                        <td>
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="edit[]" class="custom-control-input edit" id="edit_<?php echo $row["submenu_id"]; ?>" onclick="check_checkbox(<?php echo $row['submenu_id']; ?>)" <?php if ($submenu_id == $row['submenu_id']) {
                                                                                                                                                                                                                                                                    if ($edit == 1) : echo "checked";
                                                                                                                                                                                                                                                                    endif;
                                                                                                                                                                                                                                                                } ?>>
                                                                        ...
                                                                        <td>
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="view[]" class="custom-control-input view" id="view_<?php echo $row["submenu_id"]; ?>" onclick="check_checkbox(<?php echo $row['submenu_id']; ?>)" <?php if ($submenu_id == $row['submenu_id']) {
                                                                                                                                                                                                                                                                    if ($view == 1) : echo "checked";
                                                                                                                                                                                                                                                                    endif;
                                                                                                                                                                                                                                                                } ?>>
                                                                        ...
                                                                        <td>
                                                                            <div class="custom-control custom-checkbox">
                                                                                <input type="checkbox" name="delete[]" class="custom-control-input delete" id="delete_<?php echo $row["submenu_id"]; ?>" onclick="check_checkbox(<?php echo $row['submenu_id']; ?>)" <?php if ($submenu_id == $row['submenu_id']) {
                                                                                                                                                                                                                                                                            if ($delete_txt == 1) : echo "checked";
                                                                                                                                                                                                                                                                            endif;
                                                                                                                                                                                                                                                                        } ?>>
                                                ...
                                                //         $delete_txt = $row1[3];
                                                //         $submenu_id = $row1[4];
                                                //         $total = $add."_".$edit."_".$view."_".$delete_txt."_". $submenu_id;
                                                //         echo '<script type="text/javascript">', 'Checked2('.$total.');','</script>';
...
<script>
    ...
    $(document).ready(function() {
        ...
        ?>
                ...
                // Checked2(total);
                // alert(total);
                function Checked2(total) {
                    var total_data = total.split("_");
                    var add = total_data[0];
                    var edit = total_data[1];
                    var view = total_data[2];
                    var delete_txt = total_data[3];
                    var submenu_id = total_data[4];
                    // alert(add);
                    // alert(edit);

                    if (add == 1)
                        $("#add_" + submenu_id).prop("checked", true);
                    else
                        $("#add_" + submenu_id).prop("checked", false);
                    if (edit == 1)
                        $("#edit_" + submenu_id).prop("checked", true);
                    else
                        $("#edit_" + submenu_id).prop("checked", false);
                    if (view == 1)
                        $("#view_" + submenu_id).prop("checked", true);
                    else
                        $("#view_" + submenu_id).prop("checked", false);
                    if (delete_txt == 1)
                        $("#delete_" + submenu_id).prop("checked", true);
                    else
                        $("#delete_" + submenu_id).prop("checked", false);
    ...
    function Checked_back(staff_id) {
    ...
    $(document).ready(function() {
        ...
        <?php } ?>
        <?php if ($del_flag == 0) { ?>
            <?php if ($edit_add_flage == 0) : ?>
                $("#recover").show();
            <?php elseif ($edit_add_flage == 1) : ?>
                $("#recover").hide();
            <?php endif; ?>
            $("#update").hide();
            $("#delete").hide();
