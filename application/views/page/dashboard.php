                                    ...
                                    <div class="table-responsive">
                                        <table class="table table-hover m-0 table-actions-bar">
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/avatar-2.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/avatar-3.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/avatar-4.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/avatar-5.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo base_url(); ?>assets/images/users/avatar-8.jpg" alt="contact-img" title="contact-img" class="rounded-circle avatar-sm" />
                                                    </td>
