...
function(e) {
    ...
    t.prototype.init = function() {
        var t = this;
        var BSStylesheet, AppStylesheet;
        e("#mode-switch").on('change', function() {
            this.checked ? (BSStylesheet = $(this).data('bsdarkstyle'), AppStylesheet = $(this).data('appdarkstyle'), changeTheme('dark')) : 
            (BSStylesheet = $(this).data('bslightstyle'),AppStylesheet = $(this).data('applightstyle'),changeTheme('light'))
            t.$bootstrapStylesheet.attr("href", BSStylesheet),t.$appStylesheet.attr("href", AppStylesheet)
        }),
        e("#light-mode-switch").on("change", function() {
        	alert('light-mode-switch'),            
