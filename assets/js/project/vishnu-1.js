...
function getPackingType(){
    ...
    table1 = $('#vishnuPackingItem_table').DataTable({
        buttons: [{
                extend: 'copy',
                exportOptions: {
                    columns: ':visible'
...
function getItemPacking(){
    ...
    table2 = $('#vishnuItemPacking_Table').DataTable({
        buttons: [{
                extend: 'copy',
                exportOptions: {
                    columns: ':visible'
            ...
            },
            {
                ...
                titleAttr: 'PDF',
                extension: ".pdf",
                filename: "VishnuleneItemPacking",
                title: "Vishnulene Item Packing List",
                orientation: 'portrait',
            },
            'colvis'
        ],
...
function getItems(){
    ...
    table3 = $('#vishnuItems_Table').DataTable({
        buttons: [{
                extend: 'copy',
                exportOptions: {
                    columns: ':visible'
            ...
            },
            {
                ...
                titleAttr: 'PDF',
                extension: ".pdf",
                filename: "VishnuleneItems",
                title: "Vishnulene Items List",
                orientation: 'portrait',
            },
            'colvis'
        ],
...
//     table4 = $('#vishnuPricingTable_Table').DataTable({
//         buttons: [{
//                 extend: 'copy',
//                 exportOptions: {
//                     columns: ':visible'
...
//                 titleAttr: 'PDF',
//                 extension: ".pdf",
//                 filename: "VishnulenePricing",
//                 title: "Vishnulene Pricing List",
//                 orientation: 'portrait',
//             },
//             'colvis'
//         ],
...
//                             check = "checked";
//                         }
//                         action = `<input data-id="${row.id}" data-table="vishnu_5_price_list" class="verifyIt" data-size="small" type="checkbox" ${check} data-plugin="switchery" data-color="#1bb99a" data-secondary-color="#ff5d48" />`;
//                     }else{
//                         if(row.verified == 1){
...
function getPriceList(){
    ...
    table4 = $('#vishnuPricingTable_Table').DataTable({
        ...
        "dom": 'Bfrtip',
        "sAjaxSource": base_url + 'Api/'+controller+'/price_list',
        "columnDefs": [
            { "orderable": false, "targets": [6,7] },
            { className: "align-center nowrap", "targets": [ 6,7 ] },
            { className: "align-right nowrap", "targets": [ 3,5 ] }
        ],
        mark: {
            element: 'span',
            className: 'highlight'
